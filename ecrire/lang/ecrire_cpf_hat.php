...
'avis_connexion_echec_1' => '<MODIF>Koneksyon sou s&eacute;v&egrave; SQL te pa mache.',
...
'avis_connexion_echec_3' => '<MODIF><b>Atansyon</b> Ak enp&egrave; s&eacute;v&egrave; sa-yo f&ograve;k  w <b>domann</b> ou l&eacute;b&egrave;rg&egrave; te aktive laks&eacute; labaz SQL, avan w kap itilize ali. Si w vwa se pa posib m&egrave;m konek a w, ann gad byen si w te domann ali avan.',
...
'avis_erreur_connexion_mysql' => '<MODIF>Er&egrave; ak koneksyon SQL',
'avis_erreur_version_archive' => '<MODIF><b>Atansyon! Fichye @archive@ ka koresponn
...
'avis_site_syndique_probleme' => '<MODIF>Atansyon : sendikasyon pou sit sa-a gen yon pwobl&egrave;m&nbsp;; sist&egrave;m pa mache kounyen-a. Gad si ladr&egrave;s fichye sendikasyon sit-la se kor&egrave;k (<b>@url_syndic@</b>), apr&egrave;sa ann esey yon l&ograve;t rekip&eacute;rasyon enf&ograve;masyon sa-yo. ',
...
'avis_version_mysql' => '<MODIF>Ou versyon SQL (@version_mysql@) i gen pa p&eacute;mi ranje tous&egrave;l tab yo andan la bazdon&eacute;.',
...
'ical_info2' => '<MODIF>Si w vle dot ranseyman sou tout teknik anl&egrave;r, ezit pa gad <a href="@spipnet@">tout paj dokimantasyon pou SPIP</a>.',
...
'info_connexion_base' => '<MODIF>Dezyem etap : <b>Esey f&egrave; yon koneksyon sou labaz</b>',
...
'info_connexion_mysql' => '<MODIF>Premye etap : <b>Ou koneksyon SQL</b>',
...
'info_creation_tables' => '<MODIF>Katry&egrave;m etap : <b>Kreye k&egrave;k tab nan bazdone</b>',
...
'info_derniere_etape' => '<MODIF>D&egrave;nye etap : <b> se fin fini !',
...
'info_informations_personnelles' => '<MODIF>Sinky&egrave;m etap : <b>Enf&ograve;masyon p&egrave;sonel yo</b>',
...
'info_mise_a_niveau_base' => '<MODIF>M&egrave;t baz SQL nan bon nivo',
...
'info_question_inscription_nouveaux_redacteurs' => '<MODIF>Aksepte ounon pa aksepte w tout enskripsyon nouvo redakt&egrave; sou lespas piblik sit-la&nbsp;?
...
'info_restauration_sauvegarde' => '<MODIF>Rest&ograve;wasyon las&ograve;vgad @archive@',
...
'texte_admin_tech_02' => '<MODIF>Atansyon: s&ograve;vgad-la ke kapab restore SELMAN sou yon sit ki enstal&eacute; sou yon m&egrave;m v&egrave;syon SPIP. F&ograve;k pa w &laquo;&nbsp;vid labaz&nbsp;&raquo; po enstal&eacute; s&ograve;vgad-la apr&eacute; met nan nivo... Gade <a href="@spipnet@">dokimantasyon SPIP</a>.',
...
'texte_choix_base_2' => '<MODIF>S&egrave;v&egrave; SQL-la, li ka kembe k&egrave;k bazdon&eacute;.',
...
'texte_connexion_mysql' => '<MODIF>Gade tout lenf&ograve;masyon l&eacute;b&egrave;j&egrave; te bay aw&nbsp;: f&ograve;k w rankont tout kod pou koneksyon sou s&egrave;v&egrave; SQL la, si l&eacute;b&eacute;j&egrave; kabab bay yon baz SQL.',
...
'texte_jeu_caractere' => '<MODIF>Lopsyon-an se itil si sitweb-la afiche k&egrave;k alfabe diferan lalfab&eacute;
...
'texte_mots_cles_dans_forum' => '<MODIF>Aksepte w tout vizit&eacute; kapab itilize tout mokle nan fowom yo sou sit piblik&nbsp;? (Atansyon&nbsp;: lopsyon-an se konpl&egrave;ks pou itilize.)',
...
'texte_nouvelle_version_spip_2' => '<MODIF>F&ograve;k w f&egrave; yon arnouv&egrave;lman pli konple pou monte nivo nouvo v&egrave;syon an. Si w se webm&egrave;t sit-la, m&egrave;si efase fichye-a <tt>inc_connect.php3</tt> nan repetwar <tt>ecrire</tt> ak ropran lenstalasyon pou m&egrave;t param&egrave;t koneksyon sou bazdone nan nivo.<p /> (Gad.&nbsp;: si w te oubliye param&egrave;t koneksyon aw, gad fichye <tt>inc_connect.php3</tt> avan efase ali...)',
...
'texte_proposer_publication' => '<MODIF>Kan latik fini,<br /> w kapab pwopoze ali pou yon piblikasyon.',
'texte_proxy' => '<MODIF>Posib (intranet, r&eacute;zo pwoteje...),
...
'texte_referencement_automatique' => '<MODIF><b>R&eacute;f&eacute;ransman otomatik pou yon sitweb</b><br />W kapab referanse fasilman yon sitweb si w bay ladr&egrave;s URL osnon bay ladr&egrave;s fichye backend ali. SPIP ke pran otomatikman tout enf&ograve;masyon posib pou sit-la (kouman li rele, dekrisyon...).',
...
'texte_requetes_echouent' => '<MODIF><b>kank k&egrave;k rek&egrave;t SQL ki pa mache
...
'texte_restaurer_sauvegarde' => '<MODIF>Opsyon-nan ki p&eacute;m&egrave; w restore yon sovgad  ki w t&eacute; f&eacute; avan sou baz-la.
...
'texte_sauvegarde_compressee' => '<MODIF>Sovgad ke pou f&egrave; nan yon fichye pa kopr&eacute;s&eacute; sa-a, ki rele @fichier@.',
...
'texte_titre_obligatoire' => '<MODIF><b>Tit (Kouman i rele)</b> [N&egrave;s&egrave;s&egrave;]',
...
'texte_utilisation_moteur_syndiques' => '<MODIF>Kan w itilize mot&egrave;-rech&egrave;che andodan SPIP, w kapab ch&egrave;che
...
'titre_cadre_signature_obligatoire' => '<MODIF><b>Siyati</b> [N&eacute;ses&egrave;]<br />',
...
'trad_deja_traduit' => '<MODIF>Atik sa a se deja tradiksyon pou prezan atik la.',
