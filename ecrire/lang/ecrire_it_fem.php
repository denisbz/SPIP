...
'info_conflit_edition_votre_version' => '<NEW>La tua versione:',
...
'info_modifier_auteur' => '<NEW>Modifica l\'autore:',
...
'info_question_activer_compactage_css' => '<NEW>Si desidera attivare la compressione dei fogli di stile (CSS)?',
'info_question_activer_compactage_js' => '<NEW>Si desidera attivare la compressione degli script (javascript)?',
'info_question_activer_compresseur' => '<NEW>Si desidera attivare la compressione del flusso HTTP?',
...
'info_question_visiteur_ajout_document_forum' => '<NEW>Se si desidera autorizzare i visitatori ad allegare dei documenti (immagini, musiche, ecc.) ai propri messaggi nel forum, indicare qui sotto l\'elenco delle estensioni dei documenti autorizzati per i forum (per es.: gif, jpg, png, mp3).',
'info_question_visiteur_ajout_document_forum_format' => '<NEW>Se si desidera autorizzare tutti i tipi di documenti considerati affidabili da SPIP, mettere un asterisco. Per non autorizzare nulla, non indicare nulla.',
...
'info_statut_auteur' => '<MODIF>status di questa autrice:',
...
'item_autoriser_selectionner_date_en_ligne' => '<NEW>Permetti di modificare la data di ogni documento',
...
'item_compresseur' => '<NEW>Attiva la compressione',
'item_config_forums_prive_global' => '<NEW>Attiva i forum dei redattori',
'item_config_forums_prive_objets' => '<NEW>Attiva questi forum',
...
'item_login' => 'Login',
'item_messagerie_agenda' => '<NEW>Attiva la messaggistica e l\'agenda',
...
'item_non_autoriser_selectionner_date_en_ligne' => '<NEW>La data dei documenti &egrave; quella in cui sono stati aggiunti al sito.',
...
'item_non_compresseur' => '<NEW>Disattiva la compressione',
'item_non_config_forums_prive_global' => '<NEW>Disattiva i forum dei redattori',
'item_non_config_forums_prive_objets' => '<NEW>Disattiva questi forum',
...
'item_non_messagerie_agenda' => '<NEW>Disattiva la messaggistica e l’agenda',
...
// O
'onglet_contenu' => '<NEW>Contenuto',
'onglet_declarer_une_autre_base' => 'Dichiarare un altro database',
'onglet_discuter' => '<NEW>Discuti',
'onglet_documents' => '<NEW>Documenti',
