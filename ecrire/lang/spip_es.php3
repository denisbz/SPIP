...
'avis_espace_interdit' => '<B>Espacio inaccesible</B><p>SPIP ya fue instalado.',
...
'bouton_radio_enregistrement_obligatoire' => 'Inscripci&oacute;n obligatoria (los usuarios y usuarias deben abonarse dando su correo electr&oacute;nico antes de participar en el foro).',
...
'bouton_radio_moderation_priori' => 'Moderado a priori (las contribuciones no aparecen hasta ser validadas por administradores del sitio).',
