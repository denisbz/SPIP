...
'barre_guillemets' => '<MODIF> Enrodar dab &laquo; verguetas francesas &raquo;',
'barre_guillemets_simples' => '<MODIF> Enrodar dab &#8222;verguetas&#8220;',
...
'ical_texte_prive' => 'Aqueth calend&egrave;r, d\'us estrictament personau, que vs\'informa de l\'activitat editoriau privada d\'aqueth sit (&ograve;bras e rendetz-vse personaus, articles e br&egrave;vas prepausats...).',
...
'ical_texte_rss' => 'Que podetz sindicar las nautats d\'aqueth sit dens tot legider de fichi&egrave;rs en format XML/RSS (Rich Site Summary). Qu\'ei tanben lo format qui permet a SPIP de legir las nautats publicadas dens autes sits en utilizar un format d\'escambi compatible. ',
'ical_texte_rss_articles' => 'Lo fichi&egrave;r "backend" deus articles d\'aqueste sit que\'s tr&ograve;ba a l\'adre&ccedil;a:',
...
'ical_titre_rss' => 'Fichi&egrave;r &laquo;backend&raquo;',
...
'icone_edition_site' => '<MODIF> Edicion deu sit',
...
'info_afficher_visites' => '<MODIF> Afichar las vesitas t&agrave;:',
...
'info_config_suivi' => 'S\'aquera adre&ccedil;a correspond a ua lista de corri&egrave;r, que podetz indicar &ccedil;a devath l\'adre&ccedil;a on los participants au sit e p&ograve;den inscrive\'s. Aquera adre&ccedil;a que p&ograve;t estar ua URL (per exemple la pagina d\'inscripcion a la lista peu web), o ua adre&ccedil;a e-mail tienent un subj&egrave;cte especific (per exemple: <tt>@adresse_suivi@?subject=subscribe</tt>):',
...
'info_gauche_messagerie' => 'La messatgeria que\'vs permet d\'escambiar messatges entre redactors, de servar n&ograve;tas t&agrave; remembr&agrave;\'s (tau v&ograve;ste usatge personau) o d\'afichar anoncis sus la pagina d\'arcuelh de l\'espaci privat (s\'&egrave;tz administrator/tritz).',
