...
'info_admin_gere_toutes_rubriques' => 'هذا المدير يتمتع بحق إدارة <b>كل الأقسام<b>.', # MODIF
...
'info_creation_paragraphe' => '(لإنشاء فقرات يكفي ترك سطور فارغة)', # MODIF
...
'info_login_trop_court_car_pluriel' => 'يجب ان يحتوي المعرّف @nb@ حرفاً على الأقل.', # MODIF
'info_logos' => 'الشعارات',
...
'info_passe_trop_court_car_pluriel' => 'يجب ان تحتوي كلمة السر @nb@ حرفاً على الأقل.', # MODIF
...
'info_texte_message' => 'نص مشاركتك:', # MODIF
...
'texte_en_cours_validation' => 'المقالات والأخبار التالية معروضة للنشر.', # MODIF
...
'titre_langue_article' => 'لغة المقال', # MODIF
'titre_langue_rubrique' => 'لغة القسم', # MODIF
