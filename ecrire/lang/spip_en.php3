...
'info_copyright' => 'is a free software distributed <a href=\'license.txt\'>under the GPL license.</a>',
...
'info_gauche_statistiques_referers' => '<MODIF>This page displays the list of <I>referrers</I>, i.e. the sites containing links to your own site, only for today: actually this list is initialised every 24 hours.',
...
'info_historique_lien' => '<MODIF>Display list of versions',
...
'info_recherche_auteur_zero' => '<MODIF><B>No results for "@cherche_auteur@".',
...
'onglet_repartition_lang' => '<MODIF>by languages',
...
'texte_signification' => '<MODIF>Red bars represent cumulative entries (total of sub-sections), green bars represent the number of visits for each section.',
