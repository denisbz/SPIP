...
'entree_base_donnee_2' => '(Often, this address matches the address of your site, sometimes it corresponds to the name «localhost», and sometimes it is left completely empty.)',
...
'info_admin_je_suis_webmestre' => 'Je am a <b>web administrator</b>',
...
'info_compatibilite_html' => 'HTML norm to follow',
...
'info_image_process2' => '<b>N.B.</b> <i>If you can\'t see any image, then your server is not configured to use such tools. If you want to use these features, contact your provider\'s technical support and ask for the «GD» or «Imagick» extensions to be installed.</i>',
...
'texte_adresse_annuaire_1' => '( If your directory is installed on the same machine as your Web site, it is probably «localhost».)',
...
'texte_compatibilite_html' => 'You can ask SPIP to produce code compatible with the norm <i>HTML4</i> for the public site, or else allow it use more modern <i>HTML5</i> compatible code.',
...
'texte_travail_collaboratif' => 'If several editors may often   work on the same article, the system can mark the recently «opened» articles in order to avoid simultaneous changes being attempted.
