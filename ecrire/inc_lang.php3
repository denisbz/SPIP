...
function traduire_nom_langue($lang) {
	...
	'nl' => "Nederlands",
	'no' => "norsk",
	'oci_lnc' => "&ograve;c lengadocian",
	'oci_ni' => "&ograve;c ni&ccedil;ard",
	'oci_prv' => "&ograve;c proven&ccedil;au",
	'oci_gsc' => "&ograve;c gascon",
	'oci_lms' => "&ograve;c lemosin",
	'oci_auv' => "&ograve;c auvernhat",
	'oci_va' => "&ograve;c vivaroaupenc",
	'om' => "(Afan) Oromo",
	'or' => "Oriya",
	'pa' => "Punjabi",
	'pl' => "polski",
