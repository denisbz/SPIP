...
'entree_adresse_fichier_syndication' => 'Adresse der &bdquo;backend&permil;-Datei:',
'entree_adresse_site' => '<b>Adresse der Website</b> [Pflichtfeld]',
'entree_base_donnee_1' => 'Adresse des Datenbankservers',
'entree_base_donnee_2' => '(Oftmals entspricht diese Adresse der Ihrer Website, sie kann auch einfach &bdquo;localhost&permil; lauten und gelegentlich darf in diesem Feld kein Eintrag erfolgen.)',
...
'info_changer_nom_groupe' => 'Namen diese Gruppe &auml;ndern:',
'info_chapeau' => 'Kopf',
'info_chapeau_2' => 'Kopf:',
...
'info_mots_cles_association' => 'Schlagworte dieser Gruppe k&ouml;nnen zugeordnet werden:',
...
'info_ps' => 'P.S.',
'info_publie_01' => 'Der Artikel &bdquo;@titre@&permil; wurde von @connect_nom@ freigegeben.',
...
'info_qui_attribue_mot_cle' => 'Schlagworte dieser Gruppe k&ouml;nnen zugeordnet werden von:',
...
'info_recherche_auteur_ok' => 'Zu &bdquo;@cherche_auteur@&permil; wurde mehrere Autoren gefunden:',
...
'info_sauvegarde_echouee' => 'Die Sicherung ist fehlgeschlagen (&bdquo;Maximum execution time exceeded&permil;),',
...
'texte_adresse_annuaire_1' => '(Wen Ihr Verzeichnis auf dem selben Rechner installiert ist wie diese Website, m&uuml;ssen Sie wahrscheinlich &bdquo;localhost&permil; angeben.)',
...
'texte_config_groupe_mots_cles' => 'M&ouml;hten Sie die erweiterten Einstellungen f&uuml;r Schlagworte einschalten? Sie k&ouml;nnen dann z.B. die Zuordnungen auf ein Wort pro Gruppe begrenzen, eine Gruppe als besonders wichtig definieren etc.',
...
'texte_enrichir_mise_a_jour' => 'Sie k&ouml;nnen Ihren Text ansprechend gestalten, indem sie die &bdquo;typografischen Abk&uuml;rzungen&permil; verwenden.',
...
'texte_jeu_caractere' => 'Sie ben&ouml;tigen diese Option, wenn Ihre Website einen anderen Zeichensatz als den des r&ouml;mischen (bzw. &bdquo;westlichen&permil;) Alphabets und seiner Ableitungen anzeigen soll. In diesem Fall m&uuml;ssen Sie die Grundeinstellungen auf den passenden Zeichensatz &auml;ndern. Bitte vergessen Sie nicht, den &ouml;ffentlichen Bereich entsprechend zu &auml;ndern (SPIP-Tag <tt>#CHARSET</tt>).',
...
'texte_login_ldap_1' => '(Keine Angabe bzw. volst&auml;ndiger Pfad, z.B. &bdquo;<tt>uid=meier, ou=mitglieder, dc=MeineDom&auml;ne, dc=com</tt>&permil;.)',
...
'texte_plusieurs_articles' => 'Mehrere Autoren f&uuml;r &bdquo;@cherche_auteur@&permil; gefunden:',
...
'texte_recalcul_page' => 'Wen Sie nur eine einzelne Seite aktualisieren wollen, verwenden Sie besser den Schalter &bdquo; Seite aus Cache l&ouml;schen&permil;.',
...
'texte_travail_collaboratif' => 'Wenn es &ouml;fter vorkommt, dass mehrere Redakteure gemeinsam an Artikeln arbeiten, kann SPIP die  vor kurzem &bdquo;ge&ouml;ffneten&permil; Artikel anzeigen, um gleichzeitigen &Auml;nderungen vorzubeugen. Diese Funktion ist normalerweise abgeschaltet, um st&ouml;rende Meldungen zu reduzieren.',
