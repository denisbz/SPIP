...
function install_6()
{
	...
	echo "<form action='" . http_php_scriptnq("index","") . "' method='post'>";
...
function install_5()
{
	...
	echo "<form action='" . http_php_scriptnq("install","") . "' method='post'>";
...
function install_1()
{
	...
	echo "<p><form action='" . http_php_scriptnq("install","") . "' method='post'>";
...
function install_()
{
	...
	if (!$menu_langues)
	  redirige_par_entete(http_php_scriptnq("../spip_test_dirs"));
		...
		echo "<p><form action='" . http_php_scriptnq("../spip_test_dirs","") . "' method='get'>";
		echo "<DIV align='$spip_lang_right'><INPUT TYPE='submit' CLASS='fondl'  VALUE='"._T('bouton_suivant')." >>'>";
		echo "</FORM>";
		install_fin_html();
	}
