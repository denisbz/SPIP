...
'avis_site_syndique_probleme' => '<MODIF>OBS! Syndikeringen av den h&auml;r sajten har st&ouml;tt p&aring; ett problem; D&auml;rf&ouml;r &auml;r funktionen tillf&auml;lligt avbruten. Var v&auml;nlig och verifiera adressen till sajtens syndikeringsfil (<b>@url_syndic@</b>), och f&ouml;rs&ouml;k att g&ouml;ra en ny h&auml;mtning av information.',
...
'info_question_visiteur_ajout_document_forum' => '<NEW>Do you wish to authorise visitors to attach documenst (images, sound files, ...) to their forum messages?',
'info_question_visiteur_ajout_document_forum_format' => '<NEW>If so, give below the list of extensions for the file types which are to be authorised (e.g. gif, jpg, png, mp3).',
...
'item_autoriser_selectionner_date_en_ligne' => '<NEW>To be able to choose the publishing date of each document',
...
'item_non_autoriser_selectionner_date_en_ligne' => '<NEW>To not be able to change the date of documents manually',
