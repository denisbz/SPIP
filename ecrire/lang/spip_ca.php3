...
'avis_erreur_cookie' => '<NEW><PLUS_UTILISE><NEW>&ccedil;erez sorunu',
...
'info_en_test_1' => '<NEW><PLUS_UTILISE><NEW><NEW><NEW><NEW><NEW>&nbsp;(en prueba)',
...
'zbug_champ_argument_manquant' => 'Camp @champ@&nbsp;: argument absent',
