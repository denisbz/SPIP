...
'double_clic_inserer_doc' => '<NEW>Double-click to insert this shortcut in the text',
...
'info_referencer_doc_distant' => '<NEW>Reference a document on the internet:',
...
'install_echec_annonce' => '<NEW>This installation will probably not work, or will result in a nonfunctional site...',
'install_extension_mbstring' => '<NEW>SPIP does not work with:',
'install_extension_php_obligatoire' => '<NEW>SPIP requires a php extension:',
