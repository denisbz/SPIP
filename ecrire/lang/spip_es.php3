...
'ical_texte_rss' => '<MODIF> Puedes sindicar las novedades de este sitio con cualquier lector de ficheros al formato XML/RSS (Rich Site Summary). Este es tambi&eacute;n el formato que permite a SPIP leer las novedades publicadas en otros sitios que utilizan un formato de intercambio compatible. ',
...
'ical_titre_rss' => '<MODIF> Fichero &laquo;backend&raquo;',
...
'info_aujourdhui' => 'hoy:',
'info_auteur_message' => 'AUTOR O AUTORA DEL MENSAGE:',
...
'info_tous_redacteur' => 'Anuncios a todos',
...
'info_tout_site1' => 'Idioma del art&iacute;culo.',
...
'item_non_utiliser_moteur_recherche_forum' => 'No indexar los foros',
...
'item_utiliser_moteur_recherche_forum' => 'Indexar los foros',
...
'login_autre_identifiant' => 'conectarse con otro identificante',
...
'login_identifiant_inconnu' => 'El identificante &laquo;@login@&raquo; es desconocido.',
'login_identification' => 'identificaci&oacute;n',
'login_login' => 'Identificante:',
'login_login2' => 'Login (identificante de conexi&oacute;n al sitio):',
'login_login_pass_incorrect' => '(Identificante o contrase&ntilde;a incorrecta.)',
...
'menu_aide_messagerie_utilisateurs' => 'Los mensajes entre personas del sitio',
...
'pass_rappel_login' => 'Recuerda: tu identificante (login) es &laquo;@login@&raquo;.',
...
'texte_actualite_site_1' => 'Esta p&aacute;gina recapitula la actualidad del sitio y te permite seguir tus contribuciones. Encontrar&aacute;s tus art&iacute;culos en curso de redacci&oacute;n, los art&iacute;culos y las breves a las que est&aacute;s invitada a dar tu opini&oacute;n, m&aacute;s un recordatorio de tus anteriores contribuciones.<p><hr><p> Una vez que te hayas familiarizado con la interfaz, pincha en &laquo;',
...
'texte_auteur_messagerie' => 'Este sitio puede indicarte permanentemente la lista de personas conectadas, lo que permite intercambiar mensajes en directo (si m&aacute;s abajo se desactiva la mensager&iacute;a, la lista de personas conectadas tambi&eacute;n lo est&aacute;). Adem&aacute;s, puedes decidir de no aparecer en la lista (est&aacute;s &laquo;invisible&raquo; para las dem&aacute;s personas).',
...
'texte_choix_langue_defaut' => 'Elige aqu&iacute; el idioma principal de tu sitio y los idiomas que ser&aacute;n propuestos a los redactores y redactoras.',
...
'titre_cadre_afficher_traductions' => '<MODIF> Mostrar el estado de las traducciones para este idioma',
