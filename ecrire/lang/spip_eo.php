...
'avis_champ_incorrect_type_objet' => '<MODIF>Erara kampa nomo @name@ al objekto de tipo @type@',
'avis_colonne_inexistante' => 'La kolumno @col@ ne ekzistas',
'avis_echec_syndication_01' => '<MODIF>Abonrilatigo malsukcesis: la indikata backend ne estas de&#265;ifrita a&#365; proponas neniun artikolon.',
'avis_echec_syndication_02' => '<MODIF>Abonrilatigo malsukcesis: ne eblas iri al backend de tiu teksejo.',
'avis_erreur' => 'Eraro: vidu &#265;i-sube',
'avis_erreur_connexion' => 'Konekt-eraro',
'avis_erreur_cookie' => 'kuketo-problemo',
'avis_erreur_fonction_contexte' => '<MODIF>Program-eraro. Tiu funkcio ne alvokeblas en tiu &#265;i kunteksto.',
...
'form_pet_signature_pasprise' => '<MODIF>Via subskribo ne estas konsiderita.',
...
// I
'ical_texte_rss_articles' => '<MODIF>La dosiero &laquo;backend&raquo; de la artikoloj de tiu retejo troveblas &#265;e la retadreso :',
'ical_texte_rss_articles2' => '<MODIF>Vi anka&#365; povas ricevi &laquo;backend&raquo; dosierojn por artikoloj de &#265;iu rubriko de la retejo:',
...
'icone_admin_site' => 'Retej- administrado',
'icone_agenda' => 'Agendo',
...
'info_retablir_lien' => 'Restarigi tiun ligilon',
...
'info_telecharger' => '<MODIF>Al&#349;uti ekde via komputilo&nbsp;:',
'info_telecharger_nouveau_logo' => '<MODIF>&#348;argi novan vinjeton:',
'info_telecharger_ordinateur' => '<MODIF>Al&#349;uti ekde via komputilo&nbsp;:',
...
'pass_recevoir_mail' => '<MODIF>Vi ricevos retmesa&#285;on indikantan al vi kiel retrovi vian aliron al la teksejo.',
...
'texte_erreur_mise_niveau_base' => '<MODIF>Datenbazo-eraro dum la niveligo.
...
'titre_cadre_raccourcis' => '&#348;PARFAROJ:',
...
// U
'upload_fichier_zip' => 'ZIP-Dosiero (kompaktita)',
...
'zbug_boucle' => '<MODIF>ma&#349;o',
'zbug_boucle_recursive_undef' => '<MODIF>nedifinita rekursia ma&#349;o',
'zbug_champ_hors_boucle' => '<MODIF>Kampo @champ@ eksteras ma&#349;on',
'zbug_champ_hors_motif' => '<MODIF>Kampo @champ@ eksteras ma&#349;on de motivo @motif@',
'zbug_code' => 'kodo',
'zbug_critere_inconnu' => 'nekonata kriterio @critere@',
'zbug_distant_interdit' => '<MODIF>eksterne malpermisita',
'zbug_erreur_boucle_double' => 'BOUCLE@id@: duobla difino',
'zbug_erreur_boucle_fermant' => 'BOUCLE@id@: mankas fermanta marko',
'zbug_erreur_boucle_syntaxe' => '<MODIF>Mal&#285;usta sintakso de ma&#349;o',
'zbug_erreur_execution_page' => '<MODIF>eraro rulante pa&#285;on',
'zbug_erreur_filtre' => 'Eraro : filtrilo <b>&laquo; @filtre@ &raquo;</b> nedifinita',
'zbug_erreur_meme_parent' => '<MODIF>{meme_parent} nur apliki&#285;as je ma&#349;oj (FORUMS) a&#365; (RUBRIQUES)',
...
'zbug_parametres_inclus_incorrects' => '<MODIF>Ne korektaj parametroj pri enmeto',
