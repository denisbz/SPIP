...
'form_forum_voici1' => 'Vequ&iacute; lu v&ograve;stres identificants per poder participar a la vida
...
'info_forums_abo_invites' => '<NEW>V&ograve;stre sit web porg&iacute;s de forums pels abonats; dins lo sit public los vesitaires son convidats a se registrar.',
...
'info_gauche_statistiques_referers' => 'Aquela p&agrave;gina presenta la tiera dei <i>referits</i>, es a dire dei sits que contenon d\'estacs que menan drech au v&ograve;stre sit, ma unicament per i&egrave;r e ancuei&nbsp;: de fach aquela tiera es actualisada cada 24 oras.',
...
'info_historique_texte' => '<NEW>Lo seguiment de las revisions permet de servar un istoric de totas las modificacions que s\'es portat al contengut d\'un article, e d\'afichar las difer&eacute;ncias entre las versions successivas.',
...
'info_image_process2' => '<NEW><b>N.B.</b> <i>Se cap d\'imatge apareis pas, aladonc lo servidor qu\'alb&egrave;rga v&ograve;stre sit l\'an pas configurat per utilizar d\'aisinas talas. Se desiratz d\'utilizar aquelas foncions, contactatz lo responsable tecnic e demandatz las extensions &laquo;GD&raquo; o &laquo;Imagick&raquo;.</i>',
'info_image_process_titre' => '<NEW>Met&ograve;de de fabricacion de las vinhetas',
...
'info_preview_desactive' => '<NEW>La previsualizacion es del tot desactivada',
'info_preview_texte' => '<NEW>Es possible de previsualizar lo sit coma s\'avi&aacute;n publicat totes los articles e br&egrave;vas (que tenon almens l\'estatut "prepausat"). La cal dobrir, aquela possibilitat, als administrators sonque, a totes los redactors, o pas a degun?',
...
'info_question_accepter_visiteurs' => '<NEW>S\'a las esqueletas de v&ograve;stre sit web se prevei lo registrament de vesitaires sens acc&egrave;s a l\'espaci privat, volgatz activar l\'opcion seguenta:',
...
'ortho_trop_de_fautes' => '<NEW>Atencion: v&ograve;stre t&egrave;xt ten tr&ograve;p d\'errors, lai se sugger&iacute;s pas ges de correccion per tal de  subrecargar pas lo sist&egrave;ma.',
...
'taille_cache_maxi' => '<NEW>SPIP assaja de limitar la talha del repert&ograve;ri <code>CACHE/</code> d\'aquel sit a <b>@octets@</b> de donadas aperaqu&iacute;.',
...
'texte_inc_meta_1' => 'Lo sist&egrave;ma a rescontrat una error dins l\'escritura dau fichi&egrave;r <code>ecrire/data/meta_cache.php3</code>. Vorgatz, coma administrator dau sit,',
'texte_inc_meta_2' => 'verificar lu drechs d\'escritura',
'texte_inc_meta_3' => 'sus lo repert&ograve;ri <code>ecrire/data/</code>.',
...
'upload_zip_telquel' => '<NEW>installat tal coma es, coma archiu comprimit Zip;',
