...
'info_gerer_trad' => '<NEW> <NEW> G&eacute;rer les liens de traduction ?',
...
'info_langue_interface' => '<NEW> Interface\'s language',
...
'info_moyenne' => 'media: ',
'info_multi_articles' => '<NEW> Enable the language menu for the articles?',
'info_multi_cet_article' => '<NEW> <MODIF> This article is in:',
'info_multi_cette_rubrique' => '<NEW> <MODIF> This section is in:',
'info_multi_herit' => '<NEW> <MODIF> parent\'s language',
'info_multi_langues_choisies' => '<NEW> <NEW> Veuillez s&eacute;lectionner ci-apr&egrave;s les langues &agrave; disposition des r&eacute;dacteurs de votre site.
...
'info_multi_rubriques' => '<NEW> Enable the language menu for the sections?',
'info_multi_secteurs' => '<NEW> <NEW> ... seulement pour les rubriques situ&eacute;es &agrave; la racine&nbsp;?',
'info_multilinguisme' => '<NEW> Multilingual',
...
'login_rester_identifie' => '<NEW> <NEW> Rester identifi&eacute; quelques jours',
...
'onglet_evolution_visite_mod' => '<NEW> Evolution',
...
'onglet_repartition_lang' => '<NEW> by languages',
...
'texte_multilinguisme' => '<NEW> If you wish to manage articles in several languages, with a complicated navigation, you can add a language selection menu to the articles and/ot the sections, according to the organisation of your site.',
'texte_multilinguisme_trad' => '<NEW> <NEW> Vous pouvez &eacute;galement activer un syst&egrave;me de gestion de liens entre les diff&eacute;rentes traductions d\'un article.',
...
'titre_langue_article' => '<NEW> <NEW> LANGUE DE L\'ARTICLE',
'titre_langue_breve' => '<NEW> <NEW> LANGUE DE LA BR&Egrave;VE',
'titre_langue_trad_article' => '<NEW> <NEW> LANGUE ET TRADUCTIONS DE L\'ARTICLE',
...
'trad_article_inexistant' => '<NEW> There is no article with this number',
'trad_article_traduction' => '<NEW> All the versions of this article:',
'trad_deja_traduit' => '<NEW> This article is already a translation',
'trad_delier' => '<NEW> Stop linking this article to its translations',
'trad_lier' => '<NEW> This article is a translation of the article number',
'trad_new' => '<NEW> Write a new translation of this article',
'trad_reference' => '<NEW> (reference article)',
