...
'alerte_maj_impossible' => '<b>Al&egrave;rta!</b> Es impossible d\'actualisar la basa MySQL v&egrave;rs la version @version@; benl&egrave;u i a un probl&egrave;ma relatiu au drech de modificar la basa de donnadas. Vorgatz contactar lo v&ograve;stre aubergador.',
...
'avis_connexion_ldap_echec_3' => 'D\'un biais alternatiu, utilizatz pas lo sup&ograve;rt LDAP per importar d\'utilisators.',
...
'avis_deplacement_rubrique' => 'D&agrave;ida&nbsp;! Aquela rubrica conten @contient_breves@ br&egrave;vas@scb@&nbsp;: se la despla&ccedil;atz, vorgatz ben faire una taca dins aquela casa de confirmacion.',
...
'avis_erreur_version_archive' => '<b>D&agrave;ida&nbsp;! Lo fichier @archive@ corresp&ograve;nde a una autra version de SPIP qu\'aquela qu\'av&egrave;tz instalada.</b> Anatz v&egrave;rs de dificultats grandassi&nbsp;: risca de destruccion de la v&ograve;stra basa de donnadas, disfoncionaments div&egrave;rs dau sit etc. Non validetz aquela demanda d\'importacion.<p> Per mai d\'informacions, vegu&egrave;tz
...
'avis_lecture_noms_bases_2' => 'Si&aacute; minga de basa es pas disponibla, si&aacute; la foncion que permete d\'entierar li basas es estada desactivada per de rasons de segurtat (cen qu\'es lo cas de plusors aubergadors).',
...
'avis_site_syndique_probleme' => 'Atencion : la sindicacion d\'aqueu sit a encontrat un problema&nbsp;; lo sist&egrave;ma es doncas tempor&agrave;rament interromput per a&uuml;ra. Verificatz l\'adre&ccedil;a dau fichier de sindicacion d\'aqueu sit (<b>@url_syndic@</b>), e provatz mai una recuperacion dei informacions.',
'avis_sites_probleme_syndication' => 'Aquelu sits an encontrat un problema de sindicacion',
'avis_sites_syndiques_probleme' => 'Aquelu sits sindicats an pauvat un problema',
...
'barre_aide' => 'Utilisar li acorchas tipograficas per enriquir la v&ograve;stra mesa en p&agrave;gina',
...
'bouton_radio_articles_futurs' => 'ai articles futurs unicament (minga d\'accion sus la basa de donnadas).',
...
'bouton_radio_enregistrement_obligatoire' => 'Registrament obligat&ograve;ri (li utilisators si devon abonar en donant li sieus adre&ccedil;as e-mail denant de poder postar li contribucions).',
...
'bouton_radio_personnalise' => 'Ju&egrave;c de caract&egrave;rs pr&ograve;pi: chausiss&egrave;tz aquela opcion se vol&egrave;tz utilisar un ju&egrave;c especific de carat&egrave;rs',
...
'bouton_radio_universel' => 'Alfabet universal (<tt>utf-8</tt>): permete de faire veire toti li lengas, ma es pas encara acceptat per toi lu navigadors.',
...
'dirs_repertoires_absents' => '<B>Lu repert&ograve;ris seguents son pas estat trobats: <ul>@bad_dirs@.</ul> </b>
  <P>Se p&ograve;u que venga d\'un probl&egrave;ma de majusculas &ograve; minusculas mau mesi.
  Verificatz que li minusculas e majusculas d\'aquelu repert&ograve;ris correspondon ben emb cen qu\'es afichat
  &ccedil;ai sobre; s\'es pas lo cas, tornatz nomar lu repert&ograve;ris emb lo v&ograve;stre logiciau FTP per corregir l\'error.
...
'dirs_repertoires_suivants' => '<B>Lu repert&ograve;ris seguents son pas accessibles en escritura&nbsp;: <ul>@bad_dirs@.</ul> </b>
  ...
  d\'aquelu repert&ograve;ris. Lo guida d\'instalacion explica en detalh coma  procedir.
...
'entree_base_donnee_2' => '(Sovent, aquela adre&ccedil;a corresp&ograve;nde a la dau v&ograve;stre sit, de c&ograve;ups, corresp&ograve;nde a la mencion "localhost", de c&ograve;ups, es laissada vu&egrave;ia completament.)',
...
'entree_informations_connexion_ldap' => 'Vorgatz ficar dins aqueu formulari li informacions de connexion au v&ograve;stre annuari LDAD.
...
'entree_login_connexion_2' => '(Corresp&ograve;nde de c&ograve;ups au v&ograve;stre login d\'acc&egrave;s au FTP; de c&ograve;ups laissat vu&egrave;i)',
...
'entree_mot_passe_2' => '(Corresp&ograve;nde de c&ograve;ups au v&ograve;stre m&ograve;t de santa Clara per lo FTP; de c&ograve;ups es laissat vu&egrave;i)',
...
'form_forum_access_refuse' => 'Av&egrave;tz pu acc&egrave;s a aqueu sit.',
'form_forum_bonjour' => 'B&ograve;njorn,',
'form_forum_email_deja_enregistre' => 'Aquela adre&ccedil;a e-mail es ja registrada, pod&egrave;tz doncas utilisar lo v&ograve;stre m&ograve;t de santa Clara costumi&egrave;r.',
...
'form_forum_indiquer_nom_email' => 'Indicatz aqu&iacute; v&ograve;stre nom e v&ograve;stra adre&ccedil;a e-mail. V&ograve;stre identificant personau arribar&agrave; rapidament, per corrier electronic.',
...
'form_forum_voici1' => 'Vequ&iacute; lu v&ograve;stre identificants per poder participar ai forums
dau sit "@nom_site_spip@" (@adresse_site@/) :',
'form_forum_voici2' => 'Vequ&iacute; lu v&ograve;stre identificants per prepauar d\'articles 
...
'form_pet_deja_signe' => 'Av&egrave;tz ja signat aquel testo.',
...
Av&egrave;tz provedit li informacions seguenti&nbsp;:
    Nom: @nom_email@
...
'form_prop_non_enregistre' => 'La v&ograve;stra proposicion es pas estada enregistrada.',
'form_prop_sujet' => 'Subj&egrave;ct',
'form_prop_url_site' => 'Adre&ccedil;a (URL) dau sit',
'forum_acces_refuse' => 'Av&egrave;tz pu acc&egrave;s a aquelu forums.',
...
'forum_creer_paragraphes' => '(Per crear de paragrafs, laissatz simplament de linhas vu&egrave;ias)',
'forum_forum' => 'forum',
...
'forum_message_trop_long' => 'Lo v&ograve;stre messatge es tr&ograve;up l&ograve;ng. La talha maximau es de 20000 caract&egrave;rs.',
...
'forum_probleme_database' => 'Problema de basa de donadas, v&ograve;stre messatge es pas estat registrat.',
...
'forum_voir_avant' => 'V&egrave;ire aqueu messatge denant de lo postar',
...
'forum_vous_enregistrer' => 'Per participar a
  aqueste forum, vos dev&egrave;tz registrar d\'en premier. Merc&eacute;
...
'icone_activer_cookie' => 'Activar lo cookie de correspondencia',
...
'icone_supprimer_image' => 'Suprimir aquel image',
...
'icone_voir_tous_mots_cles' => 'V&egrave;ire toi lu m&ograve;ts claus',
...
'info_admin_gere_toutes_rubriques' => 'Aquel administrador gera <b>toti li rubricas</b>.',
...
'info_articles_trouves_dans_texte' => 'Articles trobats (dins lo testo)',
...
'info_breves_touvees_dans_texte' => 'Br&egrave;vas trobadi (dins lo testo)',
...
'info_code_acces' => 'Oblidetz pas lu v&ograve;stres c&ograve;des d\'acc&egrave;s pr&ograve;pris!',
'info_comment_lire_tableau' => 'Coma li&egrave;ger aqueu tableu',
'info_confirmer_passe' => 'Confirmar aqueu nov&egrave;u m&ograve;t de santa Clara:',
'info_connexion_base' => 'Segonda etapa&nbsp;: <B>Pr&ograve;va de connexion a la basa</B>',
...
'info_contenance' => 'Aqueu sit comprende&nbsp;:',
...
'info_creation_paragraphe' => '(Per crear de paragrafs, laissatz de linhas vu&egrave;ias, tot simplament)',
...
'info_derniere_syndication' => 'La darriera sindicacion d\'aqueu sit es estada efectuada lo',
...
'info_donner_rendez_vous' => 'Aqueu boton vos permete de donar un rend&egrave;tz-vos a un autre participant.',
...
'info_gauche_admin_tech' => '<B>A aquela p&agrave;gina, son que lu responsables dau sit que i p&ograve;don accedir.</B><P> Dona acc&egrave;s ai diferentas foncions de mantenen&ccedil;a tecnica. D\'unas d\'entre eli implican un proc&egrave;ssus d\'autentificacion especific, que necessita d\'aver un acc&egrave;s FTP au sit web.',
'info_gauche_admin_vider' => '<B>A aquela p&agrave;gina, son que lu responsables dau sit que i p&ograve;don accedir.</B><P> Dona acc&egrave;s ai diferentas foncions de mantenen&ccedil;a tecnica. D\'unas d\'entre eli implican un proc&egrave;ssus d\'autentificacion especific, que necessita d\'aver un acc&egrave;s FTP au sit web.',
'info_gauche_auteurs' => 'Trobaretz aqu&iacute; toi lu autors dau sit. Lo sieu estatut es indicat per la color dei sieuas ic&ograve;nas (redactor&nbsp;: verd; administrator&nbsp;: jaune).',
...
'info_gauche_suivi_forum' => 'La p&agrave;gina de <I>seguit dei forums</I> es una aisina de gestion dau v&ograve;stre sit (ma es pas un espaci de discussion &ograve; de redaccion). Fa par&eacute;isser toti li contribucions dau forum public d\'aquel article e vos permete de gerir aquelas contribucions.',
'info_gauche_suivi_forum_2' => 'La p&agrave;gina de <I>seguit dei forums</I> es una aisina de gestion dau v&ograve;stre sit (ma es pas un espaci de discussion &ograve; de redaccion). Fa par&eacute;isser toti li contribucions dei forums dau sit, autanben aqueli dau sit public coma de l\'espaci privat e vos permete de gerir aqueli contribucions.',
'info_gauche_visiteurs_enregistres' => 'Trobaretz aqu&iacute; lu visitaires enregistrats dins l\'espaci public dau sit (forums sus abonament).',
...
'info_hebergeur_desactiver_envoi_email' => 'Li son d\'aubergadors que desactivon lo mandad&iacute;s automatic d\'e-mails despu&egrave;i lu sieus servidors. En aqueu cas, li foncionalitats seguentas de SPIP foncionar&agrave;n pas.',
...
'info_installer_images_dossier' => 'Instalar d\'images dins lo dorsier /ecrire/upload per lu poder seleccionar aqu&iacute;.',
...
'info_login_existant' => 'Aqueu login existre ja.',
...
'info_mise_a_niveau_base_2' => '{{M&egrave;fi!}} Av&egrave;tz instalat una version
  ...
  avans sus aqueu sit: la v&ograve;stra basa de donnadas risca d\'&egrave;stre
  perduda e lo v&ograve;stre sit fonctionara plus.<br>{{Tornatz instalar lu
  fichiers de SPIP.}}',
'info_mise_en_ligne' => 'Data de mesa en linha:',
'info_mode_fonctionnement_defaut_forum_public' => 'M&ograve;de de foncionament de maniera predefinida dei forums publics',
...
'info_multi_langues_choisies' => 'Vorgatz seleccionar &ccedil;ai sota li lengas que son a posita dei redactors dau v&ograve;stre sit.
  Li lengas ja emplegadas dins v&ograve;stre sit (afichadas en promier) si p&ograve;don pas desactivar.',
...
'info_non_suppression_mot_cle' => 'v&ograve;li pas suprimar aqueu m&ograve;t clau.',
'info_non_utilisation_messagerie' => 'Utilisatz pas la messatgeria int&egrave;rna d\'aqueu sit.',
'info_notes' => 'N&ograve;tas',
'info_nouveau' => '(Nov&egrave;u)',
'info_nouveau_message' => 'AV&Egrave;TZ UN MESSATGE NOV&Egrave;U',
'info_nouveau_pense_bete' => 'Aqueu boton vos permete de crear una nov&egrave;la n&ograve;ta de renembran&ccedil;a personala.',
...
'info_option_email' => 'Quora un visitaire dau sit p&ograve;sta un messatge nov&egrave;u dins lo forum, associat a un article, lu autors de l\'article p&ograve;don &egrave;stre avertits d\'aqueu messatge per corrier electronic. Desiratz utilisar aquela opcion&nbsp;?',
...
'info_pense_bete_ancien' => 'Li v&ograve;stras ancianas n&ograve;tas de renembran&ccedil;a',
...
'info_rubriques_trouvees_dans_texte' => 'Rubricas trobadi (dins lo testo)',
...
'info_selection_un_seul_mot_cle' => 'Se p&ograve;u seleccionar qu\'<b>un m&ograve;t clau</b> a l\'enc&ograve;up dins aqueu grop.',
...
'info_sites_trouves_dans_texte' => 'Sits trobats (dins lo testo)',
...
'info_telecharger_nouveau_logo' => 'Encargar un nov&egrave;u l&ograve;go&nbsp;:',
...
'info_texte_long' => '(lo testo es long: apareisse doncas en tr&ograve;ses distints que si tornar&agrave;n pegar un c&ograve;up validats.)',
...
'info_travaux_texte' => 'Aqueu sit es pas encara configurat. Tornatz plus tardi...',
...
'info_utilisation_messagerie_interne' => 'Utilisatz la messatgeria int&egrave;rna d\'aqueu sit.',
...
'infos_vos_pense_bete' => 'Li v&ograve;stres n&ograve;tas de renembran&ccedil;a ',
...
'item_gerer_statistiques' => 'Gerar li estadisticas',
...
'lien_test_format_image' => 'Testar lu formats d\'images qu\'aqueu sit p&ograve;u utilisar per crear de vinhetas',
...
'login_cookie_accepte' => 'Vorgatz configurar lo v&ograve;stre navigador per que li accepte (aumens per aqueu sit).',
...
'login_nouvelle_tentative' => 'nov&egrave;la tentativa',
'login_par_ici' => 'Si&egrave;tz enregistrat... per aqu&iacute;...',
'login_pass2' => 'M&ograve;t de santa Clara&nbsp;:',
'login_preferez_refuser' => '<b>Se prefer&egrave;tz refudar lu cookies</b>, una autra metoda de conexion (mens securisada) es a v&ograve;stra disposicion&nbsp;:',
...
'menu_aide_interface_perso_cookie' => 'Lo cookie de correspond&eacute;n&ccedil;a',
...
'pass_erreur' => 'Error',
'pass_erreur_acces_refuse' => '<b>Error :</b> av&egrave;tz pus acc&egrave;s a aqueu sit.',
...
'pass_erreur_probleme_technique' => '<b>Error:</b> per l\'encausa d\'un probl&egrave;ma tecnic, l\'e-mail si p&ograve;u pas mandar. ',
'pass_espace_prive_bla' => 'L\'espaci privat d\'aqueste sit es dub&egrave;rt ai
  visitaires que si son inscriches. Un c&ograve;up registrat/ada,
  poderetz consultar lu articles en cors de redaccion,
  prepauvar d\'articles nov&egrave;us e participar a toi lu forums.',
...
Poderetz intrar un m&ograve;t de santa Clara nov&egrave;u
...
'text_article_propose_publication' => 'Article prepauvat per la publicacion. Esitetz pas de donar lo v&ograve;stre vejaire gra&ccedil;a au forum estacat a aquel article (en bas de p&agrave;gina).',
'texte_acces_ldap_anonyme_1' => 'Certens servidors LDAP accepton minga d\'acc&egrave;s anonim. En aqueu cas, cau especificar un identificant d\'acc&egrave;s iniciau per poder pu&egrave;i recercar d\'informacions dins l\'annuari. Lu camps seguents se podr&agrave;n qualora laissar vu&egrave;is dins la m&agrave;ger part dei cases.',
'texte_actualite_site_1' => 'Aquela p&agrave;gina recensa l\'actualitat dau sit e vos permete de seguir li v&ograve;stri contribucions. I tornaretz trobar lu v&ograve;stres articles en cors de redaccion, lu articles e li br&egrave;vas que si&egrave;tz convidat de li&egrave;ger per donar la v&ograve;stra vejaire, pu&egrave;i una renembran&ccedil;a dei v&ograve;stri contribucions.<p><hr><p>Quora seretz familiarisat/ada emb l\'interfa&ccedil;a, podretz clicar sus "',
'texte_actualite_site_2' => 'interf&agrave;&ccedil;a completa',
'texte_actualite_site_3' => '\\" per aver mai de possibilitats.',
'texte_admin_effacer_01' => 'Aquela comanda escafa <i>tot</i> lo contengut de la basa de donnadas,
 incluses <i>toi</i> lu acc&egrave;sses redactors e administrators. Un c&ograve;up que l\'auretz executada, auretz da tornar lan&ccedil;ar l\'instalacion de SPIP per tornar crear una basa nov&egrave;la coma pura un promi&egrave;r acc&egrave;s administrator.',
...
'texte_adresse_annuaire_1' => '(Se v&ograve;stre annuari es instalat sus la meme maquina qu\'aqueu sit web, s\'ag&iacute;s probablament de "localhost".)',
...
'texte_commande_vider_tables_indexation' => 'Utilisatz aquela comanda per vuar li taulas d\'indexacion utilisadas per lo motor de recerca integrat a SPIP. Aqu&ograve; permetra de ganhar d\'espaci disc.',
...
'texte_crash_base' => 'Se v&ograve;stra basa de donadas s\'es
 ...
 automatica.',
'texte_creation_automatique_vignette' => 'La creacion automatica de vinhetas de previsualisacion es activada sus aqueu sit. S\'instalatz a partir d\'aqueu formulari d\'images au(ai) format(s) @gd_formats@, seran acompanhats d\'una vinheta d\'una talha maximala de @taille_preview@ pix&egrave;ls.',
...
'texte_demander_blocage_priori' => 'Lu estacs seguents en provenen&ccedil;a d\'aqueu sit seran blocats <i>a pri&ograve;ri</i>.',
...
'texte_documents_joints' => 'Pod&egrave;tz autorisar l\'apondon de documents (fichiers burotics, images multim&egrave;dia, etc.) ai articles e/&ograve; ai rubricas. Aquelu fichiers p&ograve;don pu&egrave;i &egrave;stre referen&ccedil;ats dins l\'article, &ograve; apar&eacute;isser desseparadament.<p>',
'texte_documents_joints_2' => 'Aqueu reglatge empedi pas l\'insercion d\'images directament dins lu articles.',
'texte_effacer_base' => 'Escassar la basa de donadas SPIP',
'texte_effacer_donnees_indexation' => 'Escafar li donadas d\'indexacion',
'texte_en_cours_validation' => 'Se prepauva de publicar lu articles e br&egrave;vas &ccedil;ai sota. Esitetz pas de donar la v&ograve;stra vejaire gra&ccedil;a ai forums que i son estacats.',
...
'texte_erreur_mise_niveau_base' => 'Error de basa de donnadas pendent la mesa a niv&egrave;u. L\'image <B>@fichier@</B> es pas passada (article @id_article@).
  Notatz ben aquela referen&ccedil;a, tornatz ensajar la mesa a niv&egrave;u, e verificatz pu&egrave;i que li images apar&eacute;isson encara dins lu articles.',
'texte_fichier_authent' => '<b>Deu crear, SPIP, de fichiers especials  <tt>.htpasswd</tt>
  ...
  e administrators en d\'autri lu&egrave;cs dau v&ograve;stre sit
...
'texte_inc_auth_1' => 'Si&egrave;tz identificat/ada coma
   <B>@auth_login@</b>, ma aqueu login exista pas &ograve; pas plus mai dins la basa.
  Temptatz de vos',
...
'texte_jeu_caractere' => 'Aquesta opcion es utila se lo v&ograve;stre sit deu afichar d\'alfabets
 diferents de l\'alfabet latin (&ograve; "occidentau") e li sieus derivats.
 Dins aqueu cas, cau cambiar lo reglatge predefinit per utilisar
 un ju&egrave;c de caract&egrave;rs apropriat. Oblidetz pas d\'adaptar
...
'texte_jeu_caractere_2' => 'Aqueste reglatge a pas d\'efet retroactiu. Donca
 lu testos ja sasits se p&ograve;don afichar
...
'texte_mots_cles_dans_forum' => 'Desiratz, vos, de permetre l\'utilisacion deis m&ograve;ts claus, seleccionables per lu visitaires, dins lu forums dau sit public? (Atencion: es pron compl&egrave;xe d\'utilisar aquela opcion correctament.)',
...
'texte_non_compresse' => '<i>non compressat</i> (lo v&ograve;stre servidor suporta pas aquela foncionalitat)',
'texte_non_fonction_referencement' => 'Pod&egrave;tz chausir d\'utilisar pas aquela foncion automatica, e indicar de vos meme lu elements que tocan aqueu sit...',
...
'texte_rappel_selection_champs' => '[Oblidetz pas de seleccionar corr&egrave;ctament aqueu camp.]',
...
'texte_suppression_fichiers' => 'Utilisatz aquela comanda per suprimir toi lu fichiers que se tr&ograve;ban
...
'titre_probleme_technique' => 'Atencion: un probl&egrave;ma tecnic (servidor MySQL) empacha d\'accedir a aquela part dau sit. Merc&eacute; de la v&ograve;stra indulgen&ccedil;a.',
...
'trad_article_inexistant' => 'Li a pas d\'article que p&ograve;rton aqueu n&uacute;mero.',
...
'trad_new' => 'Escrieure una nov&egrave;la revirada d\'aquel article',
