...
'texte_inc_config' => 'De wijzigingen die op deze pagina worden aangebracht,
 ...
 site.</B>',
'texte_inc_meta_1' => '<MODIF>Gelieve, als beheerder van de site,',
'texte_inc_meta_2' => '<MODIF>de schrijfrechten te verifi&euml;ren',
'texte_inc_meta_3' => '<MODIF>van de map ecrire/',
...
'texte_recapitiule_liste_documents' => '<MODIF>Deze pagina herneemt de lijst met documenten die je bij de rubrieken hebt geplaatst. Om de informatie van een document te wijzigen, volg je de link naar de bladzijde binnen zijn rubriek.',
