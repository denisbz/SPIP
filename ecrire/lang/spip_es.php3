...
'bouton_forum_petition' => 'Foro y petitorio',
...
'bouton_radio_articles_tous_sauf_forum_desactive' => 'a todos los art&iacute;culos, salvo los que no tienen foro.',
...
'bouton_radio_occidental' => 'Alfabeto occidental (<tt>iso-8859-1</tt>): soportado por todos los navegadores, permite mostrar las lenguas europeas del oeste.',
...
'bouton_radio_petition_activee' => 'Petitorio activado',
...
'bouton_radio_supprimer_petition' => 'Suprimir el petitorio',
'bouton_radio_syndication' => 'Sindicaci&oacute;n',
'bouton_radio_universel' => 'Alfabeto universal (<tt>utf-8</tt>): permite mostrar todas las lenguas pero no es reconocido por todos los navegadores.',
...
'entree_base_donnee_2' => '(A menudo, esta direcci&oacute;n corresponde a la de vuestro sitio, a veces tambi&eacute;n, corresponde a "localhost" y a veces se la deja vac&iacute;a)',
...
'entree_mot_passe_1' => 'Vuestro contrase&ntilde;a de conexi&oacute;n',
'entree_mot_passe_2' => '(A veces corresponde a vuestro contrase&ntilde;a FTP y a veces se deja vac&iacute;o)',
...
'icone_arret_discussion' => 'Abandonar esta discusi&oacute;n',
...
'icone_mots_cles' => 'Palabras claves',
...
'icone_repartition_actuelle' => 'Mostrar la repartici&oacute;n actual',
'icone_repartition_debut' => 'Mostrar la repartici&oacute;n desde el comienzo',
'icone_retour' => 'Volver',
...
'icone_suivi_forum' => 'Actualidad del foro p&uacute;blico: @nb_forums@&nbsp;contribuci&oacute;n(s)',
...
'icone_voir_tous_mots_cles' => 'Ver todas las palabras claves',
...
'info_affichier_visites_articles_plus_visites' => 'Mostrar las visitas de <b>los art&iacute;culos m&aacute;s visitados desde el comienzo</b>',
'info_aide' => 'Ayuda :',
...
'info_descriptif' => 'Descripcci&oacute;n',
'info_descriptif_nombre' => 'descripcci&oacute;n(es)',
'info_description' => 'Descripcci&oacute;n',
'info_description_2' => 'Descripcci&oacute;n',
...
'info_forum_ouvert' => 'En el espacio privado un foro est&aacute; abierto a todos los redactores. Se puede crear tambi&eacute;n un foro elitista para los administradores.',
...
'info_gauche_auteurs' => 'Aqu&iacute; figuran todos los autores y sus respectivos estados. 
Verde = redactores; Amarillo = administradores. ',
...
'info_gauche_statistiques_referers' => 'Esta es la lista de los  <I>referers</I>, o sea los sitios con enlaces que llevan a este sitio. Se actualiza todas las 24 h.',
'info_gauche_suivi_forum' => 'La <I>gesti&oacute;n de los foros</I> muestra las contribuciones del foro de este art&iacute;culo y no constituye un espacio de discusi&oacute;n.',
'info_gauche_suivi_forum_2' => 'La <I>gesti&oacute;n de los foros</I> muestra las contribuciones del foro de este art&iacute;culo y no constituye un espacio de discusi&oacute;n.',
...
'info_installation_systeme_publication' => 'Instalaci&oacute;n du sistema de publicaci&oacute;n...',
...
'info_mail_fournisseur' => 'ud@prestatario.???',
...
'info_sauvegarde_mots_cles' => 'Crear copia de seguridad de las palabras claves',
...
'info_statut_utilisateurs_2' => 'Elegir el estado a atribuir a las personas presentes en ',
'info_statut_utilisateurs_3' => ' el anuario LDAP cuando se conectan por primera vez. ',
'info_statut_utilisateurs_4' => 'Luego, vosotros podr&eacute;is modificar el estado caso por caso. ',
...
'info_total' => 'Total:',
'info_tous_articles_en_redaction' => 'Todos los art&iacute;culos en curso',
'info_tous_articles_presents' => 'Todos los art&iacute;culos publicados de esta secci&oacute;n',
'info_tous_les' => ' todos los:',
'info_tous_redacteur' => 'Anuncios a los redactores ',
'info_tous_redacteurs' => 'Anuncios a los redactores ',
'info_tous_resultats_enregistres' => '  [todos los resultados son enregistrados]',
...
'info_visites_plus_populaires' => 'Mostrar las visitas de <b>los art&iacute;culos m&aacute;s populares</b> y de <b>los &uacute;ltimos art&iacute;culis publicados</b>',
...
'item_lundi' => 'lunes',
'item_mardi' => 'martes',
'item_mercredi' => 'mi&eacute;rcoles',
...
'item_non_utiliser_config_groupe_mots_cles' => 'No utilizar la configuraci&oacute;n precisa de los grupos de palabras claves',
'item_non_utiliser_moteur_recherche' => 'No utilizar el motor',
'item_non_utiliser_mots_cles' => 'No utilizar las palabras claves',
...
'item_samedi' => 's&aacute;bado',
'item_utiliser_breves' => 'Utilizar las breves',
'item_utiliser_config_groupe_mots_cles' => 'Utilizar la configuraci&oacute;n precisa de los grupos de palabras claves',
'item_utiliser_moteur_recherche' => 'Utilizar el motor de b&uacute;squeda',
'item_utiliser_mots_cles' => 'Utilizar las palabras claves',
'item_utiliser_syndication' => 'Utilizar la sindicaci&oacute;n autom&aacute;tica',
'item_vendredi' => 'viernes',
...
'menu_aide_articles_descriptif_rapide' => 'Descripciones (NDT: se utiliza en el sumario, en las secciones, en el mapa...)',
...
'menu_aide_installation_ftp' => 'Verificaci&oacute;n v&iacute;a FTP',
...
'menu_aide_installation_reactuliser_droits' => 'Reglar los derechos de acceso',
...
'menu_aide_mots_cles_mots_cles' => 'Las palabras claves...',
'menu_aide_mots_cles_principe' => 'Principios de las palabras claves',
...
'menu_aide_suivi_forum_articles_postes' => 'Art&iacute;culos postdatados',
...
'mois_aout' => 'agosto',
'mois_avril' => 'abril',
'mois_decembre' => 'diciembre',
'mois_fevrier' => 'febrero',
'mois_janvier' => 'enero',
'mois_juillet' => 'julio',
'mois_juin' => 'junio',
'mois_mai' => 'mayo',
...
'mois_novembre' => 'noviembre',
'mois_octobre' => 'octubre',
'mois_septembre' => 'septiembre',
...
'onglet_repartition_rubrique' => 'Repartici&oacute;n por secciones',
...
'texte_acces_ldap_anonyme_1' => 'Algunos servidores LDAP no aceptan accesos an&oacute;nimos. En ese caso  ',
'texte_acces_ldap_anonyme_2' => 'deb&eacute;is especificar un identificador de acceso inicial para poder ',
'texte_acces_ldap_anonyme_3' => 'luego buscar informaciones en el anuario. En la mayor&iacute;a de los casos ',
'texte_acces_ldap_anonyme_4' => 'los campos siguientes pueden estar vac&iacute;os.',
...
'texte_admin_tech_01' => 'Esta opci&oacute;n permite crear una copia de seguridad de la base en el directorio <i>ecrire/data/</i>.
deber&eacute;is crear la copia de seguridad manualmente en el directorio <i>IMG/</i>, que contiene las im&aacute;genes utilizadas en el sitio desde el comienzo.',
...
'texte_adresse_annuaire_1' => '(Si vuestro anuario est&aacute; instalado en la misma m&aacute;quina que el sitio Web,  ',
'texte_adresse_annuaire_2' => 'se trata probablemente de "localhost".)',
'texte_ajout_auteur' => 'El autor siguiente ha sido a&ntilde;adido al art&iacute;culo:',
'texte_annuaire_ldap_1' => 'Si tienes un acceso a un anuario (LDAP), puedes utilizarlo para',
'texte_annuaire_ldap_2' => ' importar autom&aacute;ticamente usuarios de SPIP.',
...
'texte_choix_base_3' => '<B>Seleccione</B> aqu&iacute; le que le ha sido atribu&iacute;da por el prestatario:',
...
'texte_comment_lire_tableau' => 'El rango del art&iacute;culo el su clasificaci&oacute;n por popularidad es indicado al margen, la popularidad (una estimaci&oacute;n de las visitas que recibir&aacute; si el ritmo actual no decae) y el n&uacute;mero de visitas recibidas desde el comienzo se muestran en un men&uacute; que aparece cuando la rata sobrevuela el t&iacute;tulo.',
...
'texte_connexion_mysql' => 'Encontrar&eacute;is los c&oacute;digos de conexi&oacute;n al servidor MySQL en la documentaci&oacute;n que os ha entregado vuestro prestatario.',
...
'texte_login_ldap_1' => '(Dejar en blanco para un acceso an&oacute;nimo, o indicar la ruta completa,',
'texte_login_ldap_2' => 'por ejemplo "<tt>uid=perez, ou=users, dc=mi-dominio, dc=com</tt>".)',
...
'texte_signification' => 'Las barras rojas representan las entradas del total de las subsecciones y las verdes las visitas por cada secci&oacute;n.',
'texte_sous_titre' => 'Subt&iacute;tulo',
'texte_statistiques_visites' => 'Barras oscuras: domingos. Cuvas oscuras: evoluci&oacute;n del promedio.',
...
'texte_suppression_fichiers' => 'Utilizad este instrucci&oacute;n  con el fin de suprimir todos los ficheros presentes en la cach&eacute; de SPIP. Esto permite, por ejemplo, forzar un recalculo de todas las p&aacute;ginas si hab&eacute;is hecho importantes  modificaciones gr&aacute;ficas o de la estructura del sitio.',
...
Un segundo m&eacute;todo, mucho mas potente, permite a SPIP buscar igualmente en el texto de los sitios referenciados. Si referenci&aacute;is un sitio, SPIP efectuar&aacute; entonces la b&uacute;squeda dentro del texto del sitio mismo.',
...
'titre_config_groupe_mots_cles' => 'Configuraci&oacute;n de los grupos de palabras claves',
