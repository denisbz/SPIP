...
'info_forums_abo_invites' => 'Lo v&ograve;stre sit web porg&iacute;s de forums per lu abonats; dins lo sit public lu vesitaires son convidats a se registrar.',
...
'info_historique_texte' => '<NEW>Lo seguiment dei revisions permet de servar un istoric de totei lei modificacions que s\'es portat au contengut d\'un article, e d\'afichar lei difer&eacute;ncias entre lei versions successivas.',
...
'info_image_process2' => '<NEW><b>N.B.</b> <i>Se ges d\'imatge apareis, aladonc lo servidor qu\'aub&egrave;rga v&ograve;stre sit l\'an pas configurat per utilizar d\'aisinas talas. Se desiratz d\'utilizar aquelei foncions, contactatz lo responsable tecnic e demandatz leis extensions &laquo;GD&raquo; o &laquo;Imagick&raquo;.</i>',
...
'info_preview_texte' => '<NEW>Es possible de previsualizar lo sit coma s\'avi&aacute;n publicat totei leis articles e br&egrave;vas (que tenon aumens l\'estatut "prepausat"). La cau dobrir, aquela possibilitat, ren qu\'ais administrators, a totei lei redactors, o en degun?',
...
'info_question_accepter_visiteurs' => '<NEW>S\'ais esqueletas de v&ograve;stre sit web se prevei lo registrament de vesitaires sens acc&egrave;s a l\'espaci privat, vougatz activar l\'opcion seguenta:',
...
'ortho_trop_de_fautes' => '<NEW>Atencion: v&ograve;stre t&egrave;xt ten tr&ograve;p d\'errors, i se sugger&iacute;s ges de correccion per fin de pas subrecargar lo sist&egrave;ma.',
...
'taille_cache_maxi' => '<NEW>SPIP assaja de limitar la talha da repert&ograve;ri <code>CACHE/</code> d\'aqueu sit a <b>@octets@</b> de donadas aperaqu&iacute;.',
