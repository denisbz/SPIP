...
'barre_eo_maj' => 'E batO maiuskulan sartu',
...
'form_forum_voici2' => 'Hona hemen zure identifikadoreak, artikuluak ,"@nom_site_spip@" (@adresse_site@/ecrire/) lekuan proposatzeko:',
...
'info_creer_vignette' => '<MODIF>creación automática de la miniatura',
...
'info_installer_ftp' => 'Administrazioeskubideekin, ecrire/upload karpetan fitxategiak instala ditzakezu (FTP bidez)gero zuzenean hemen hautatu ahal izateko.',
'info_installer_images' => 'JPEG, GIF eta PNG formatudun irudiak ezar ditzakezu.',
'info_installer_images_dossier' => 'Irudiak instalatu ecrire/upload karpetan gerozuzenean hemen hautatu ahal izateko.',
...
'pass_mail_passcookie' => '(hau mezu automatikohau da) Zure sarbidea berreskuratzeko  @nom_site_spip@ gunera (@adresse_site@) Hurrengohelbidera joan: @adresse_site@/spip_pass.php3?p=@cookie@ Orduan pasahitzberri bat jarri eta gunera berriz konektatu ahalko zara. ',
