...
'avis_conseil_selection_mot_cle' => '<b>Ampleksa grupo:</b> Estas konsilate elekti &#349;losilvorton en tiu grupo.',
...
'avis_sites_probleme_syndication' => 'Okazis problemo pri abonrilato de tiuj retejoj',
'avis_sites_syndiques_probleme' => 'Okazis problemo al tiuj abonrilatigitaj retejoj',
...
'bouton_radio_enregistrement_obligatoire' => 'Deviga memregistri&#285;o (la uzantoj devas aboni&#285;i, entajpante sian retpo&#349;tadreson anta&#365; ol sendi kontribuojn).',
...
'bouton_radio_moderation_priori' => 'Apriora moderigado (kontribuoj estas publikigataj nur post validigo de moderigantoj).',
...
'calendrier_synchro' => '<MODIF>Se vi uzas agend-programon kongruan kun <b>iCal</b> formato, vi povas &#285;isdatigi tiun kun la datenoj de tiu retejo.',
...
'double_clic_inserer_doc' => 'Dufoje musklaku por enigi tiun &#349;parvojon en la tekston',


// E
'email' => 'retpo&#349;tadreso',
'email_2' => 'retpo&#349;tadreso:',
'entree_adresse_annuaire' => '<MODIF>Adreso de la dosierujilo',
...
'entree_base_donnee_2' => '<MODIF>(Tiu adreso ofte estas tiu de via retejo, foje korespondas al la mencio "localhost" , alifoje la &#265;elo restas malplena.)',
...
'entree_informations_connexion_ldap' => '<MODIF>En tiun formularon bonvolu entajpi informojn por ensaluti en via LDAP-dosierujilo. Tiujn informojn disponigu la sistema a&#365; reta administranto.',
...
'entree_login_connexion_2' => '<MODIF>(Foje korespondas al via salutnomo por eniri la FTP-ejon; foje &#285;i restas malplena)',
'entree_login_ldap' => 'Komenca salutnomo por LDAP',
'entree_mot_passe' => 'Via pasvorto',
'entree_mot_passe_1' => 'La pasvorto por ensaluti',
'entree_mot_passe_2' => '<MODIF>(Foje korespondas al via pasvorto por la FTP-ejo; foje &#285;i restas malplena)',
...
'entree_port_annuaire' => '<MODIF>La numero de la dosierujila pordo',
...
'ical_info2' => 'Por pli da informoj pri &#265;i &#265;iuj teknikoj, senhezite konsultu <a href="http://www.spip.net/fr_suivi">la documentaron de SPIP</a>.',
...
'ical_methode_http' => 'El&#349;uto',
'ical_methode_webcal' => '<MODIF>&#284;isdatigo (webcal://)',
'ical_texte_js' => 'Per ununura linio de javascript, vi povas simplege afi&#349;i &#265;e kiu ajn retejo, kiun vi havas, la lastajn artikolojn publikigitajn &#265;e tiu retejo.',
...
'icone_ecrire_nouvel_article' => 'La fulm-informoj enhavataj en tiu rubriko',
'icone_envoyer_message' => 'Sendi tiun mesa&#285;on',
'icone_evolution_visites' => 'Evoluo de la vizitoj<br>@visites@ vizitoj',
...
'icone_referencer_nouveau_site' => 'Referenci novan retejon',
...
'info_activer_forum_public' => '<i>Por aktivigi la publikajn forumojn, bonvolu elekti ties
...
'info_aide_en_ligne' => 'Reta SPIP-helpo',
'info_ajout_image' => '<MODIF>Kiam vi aldonas bildojn kiel alkro&#265;itajn dokumentojn al artikolo,
...
'info_base_restauration' => 'La datenbazo estas resta&#365;rata.',
'info_bloquer' => 'bloki',
...
'info_chapeau' => '<MODIF>&#264;apelo',
'info_chapeau_2' => '<MODIF>&#264;apelo&nbsp;:',
'info_chemin_acces_1' => '<MODIF>Opcioj : <b>Alirvojo en la LDAP-dosierujilo</b>',
'info_chemin_acces_2' => '<MODIF>Ekde nun vi devas konfiguri la alirvojon al la LDAP-dosierujilo. Tiu informo estas nepre necesa por legi la profilojn de uzantoj stokataj en la dosierujilo.',
'info_chemin_acces_annuaire' => '<MODIF>Opcioj: <B>Aliro al la LDAP-dosierujilo',
...
'info_config_suivi' => 'Se tiu adreso estas tiu de dissendolisto, indiku &#265;i-sube la adreson &#265;e kiu la partoprenantoj de la retejo povos registri&#285;i. Tiu adreso povas esti ret-ligilo (ekz. la pa&#285;o por rete registri&#285;i en la listo), a&#365; retpo&#349;tadreso kun specifa temo (ekz. <tt>@adresse_suivi@?subject=registrigi</tt>):',
...
'info_desactiver_forum_public' => '<MODIF>Malaktivigi la uzon de la publikaj forumoj.
La publikaj forumoj estos unu post la alia permesitaj
 koncerne la artikolojn; ili estos malpermesataj koncerne rubrikojn, fulm-informojn, ktp.',
...
'info_facilite_suivi_activite' => 'Por faciligi la kontrolon de la reteja &#265;efartikola aktivo, SPIP povas transdoni per retmesa&#285;oj - ekzemple al dissendolisto de redaktantoj -  la pet-anoncon pri publikigo kaj validigoj de artikoloj.',
...
'info_forum_ouvert' => 'En la privata spaco de la teksejo, forumo estas malfermita al &#265;iuj
  registritaj redaktantoj. Vi povas, &#265;i-sube, aktivigi
  plian forumon, rezervitan nur al administrantoj.',
...
'info_gauche_admin_effacer' => '<b>Nur administrantoj de la retejo rajtas aliri tiun pa&#285;on.</b><p />&#284;i ebligas aliron al la diversaj funkcioj pri teknika bontenado. Iuj el ili rezultigas specifan a&#365;tentigan procezon, kiu postulas FTP-aliron al la retejo.',
'info_gauche_admin_tech' => '<b>Nur administrantoj de la retejo rajtas aliri tiun pa&#285;on.</b><p />&#284;i ebligas aliron al la diversaj funkcioj pri teknika bontenado. Iuj el ili rezultigas specifan a&#365;tentigan procezon, kiu postulas FTP-aliron al la retejo.',
'info_gauche_admin_vider' => '<b>Nur administrantoj de la retejo povas aliri tiun pa&#285;on.</b><p />&#284;i ebligas aliron al la diversaj funkcioj pri teknika bontenado. Iuj el ili rezultigas specifan a&#365;tentigan procezon, kiu postulas FTP-aliron al la retejo.',
'info_gauche_auteurs' => 'Vi trovos &#265;i tie &#265;iujn a&#365;torojn de la retejo. Ilia statuso estas indikita per koloro de sia piktogramo (administranto = verda, redaktanto = flava).',
'info_gauche_auteurs_exterieurs' => 'La eksteraj a&#365;toroj, sen alireblo al la retejo, estas indikitaj per blua piktogramo&nbsp;;
 la a&#365;toroj forigita per bildo de rubujo.',
'info_gauche_messagerie' => 'La mesa&#285;ilo ebligas al vi inter&#349;an&#285;i mesa&#285;ojn inter a&#365;toroj, konservi memorigilojn (por via propra uzado) a&#365; afi&#349;i anoncojn sur la hejmpa&#285;o de la privata spaco (se vi estas administranto).',
'info_gauche_numero_auteur' => 'A&#364;TORA NUMERO',
'info_gauche_numero_breve' => 'FULM-INFORMA NUMERO',
'info_gauche_statistiques_referers' => '<MODIF>Tiu pa&#285;o prezentas la liston de la  <i>referencejoj</i>, tio estas retejoj enhavantaj ligilojn al via propra retejo, nur koncerne hiera&#365; kaj hodia&#365;&nbsp;: tiu listo estas prastatigita &#265;iujn 24 horojn.',
'info_gauche_suivi_forum' => 'La pa&#285;o pri <i>kontrolo de la forumoj</i> estas mastrumilo de via retejo (kaj ne diskutejo a&#365; redaktejo). &#284;i afi&#349;as &#265;iujn kontribua&#309;ojn de la publika forumo pri tiu artikolo, kaj ebligas al vi mastrumi tiujn kontribua&#309;ojn.',
'info_gauche_suivi_forum_2' => 'La pa&#285;o pri <i>kontrolo de la forumoj</i> estas mastrumilo de via retejo (kaj ne diskutejo a&#365; redaktejo). &#284;i afi&#349;as &#265;iujn kontribua&#309;ojn de la forumoj (de la publika spaco same kiel de la privata), kaj ebligas al vi mastrumi tiujn kontribua&#309;ojn.',
...
'info_historique_texte' => '<MODIF>La supervido de revizioj ebligas konservi historion de &#265;iuj modifoj al la enhavo de artikolo, kaj afi&#349;i la diferencojn inter la sinsekvaj versioj.',
...
'info_image_process2' => '<b>N.B.</b> <i>Se neniu bildo afi&#349;i&#285;as, tio signifas ke la servilo kiu gastas vian retejon ne estas konfigurita por tia iloj. Se vi deziras uzi tiujn funkciojn, petu la &laquo;GD&raquo; a&#365; &laquo;Imagick&raquo; modulojn al la teknika administranto.</i>',
...
'info_jours' => 'tagoj',
'info_laisser_champs_vides' => '<MODIF>lasi tiujn kampojn malplenaj)',
...
'info_liste_redacteurs_connectes' => 'Listo de la ensalutintaj redaktantoj',
...
'info_mise_a_niveau_base' => '<MODIF>niveligo de via MySQL-datenbazo',
'info_mise_a_niveau_base_2' => '{{Atentu!}} Vi &#309;us instalis version de la SPIP-dosieroj {anta&#365;an} al tiu, kiu estis instalita &#265;e via retejo: eblas ke via datenbazo perdi&#285;os kaj via retejo ne plu funkcios. {{Reinstalu la SPIP-dosierojn.}}',
'info_mode_fonctionnement_defaut_forum_public' => '<MODIF>Defa&#365;lta funkcimodo de la publikaj forumoj',
...
'info_multi_langues_choisies' => 'Bonvolu elekti &#265;i-sube la lingvojn disponeblajn al la redatistojn de via retejo.
  La lingvojn jam uzatajn en via retejo (&#265;ef-afi&#349;itaj), vi ne povas malaktivigi.',
'info_multi_rubriques' => '&#264;u aktivigi la lingvomenuon en la rubrikoj&nbsp;?',
'info_multi_secteurs' => '... nur por la rubrikoj situantaj &#265;e la radiko&nbsp;?',
'info_nom' => 'Nomo',
...
'info_non_envoi_annonce_dernieres_nouveautes' => 'SPIP povas regule sendi anoncon pri la lastaj nova&#309;oj de la retejo (artikoloj kaj fulm-informoj fre&#349;e publikigitaj).',
...
'info_option_accepter_visiteurs' => 'Permesi registri&#285;ojn de vizitantoj el la publika retejo',
'info_option_email' => 'Kiam vizitanto de la retejo sendas novan mesa&#285;on en la forumo
 ligita kun artikolo, eblas retpo&#349;te sciigi pri tiu mesa&#285;o al la a&#365;toroj de la artikolo. &#264;u vi deziras uzi tiun eblon&nbsp;?',
...
'info_options_avancees' => '<MODIF>AMPLEKSAJ EBLOJ',
...
'info_pour' => 'por',
'info_preview_admin' => 'Nur la administrantoj povas anta&#365;vidi la retejon',
'info_preview_comite' => '&#264;iuj redaktantoj povas anta&#365;vidi la retejon',
'info_preview_desactive' => 'La anta&#365;videblo estas malaktivigita',
'info_preview_texte' => 'Eblas anta&#365;vidi la retejon kvaza&#365; ciuj artikoloj kaj fulm-informoj (kiuj almena&#365; havas la &laquo;&nbsp;proponitan&nbsp;&raquo; statuson) estus publikigitaj. &#264;u tio eblu nur al mastrumantoj, al &#265;iuj redaktantoj, a&#365; al neniu&nbsp;?',
...
'info_question_gerer_statistiques' => '&#264;u via retejo devas mastrumi la statistikojn de la vizitoj&nbsp;?',
'info_question_inscription_nouveaux_redacteurs' => '&#264;u vi akceptas la registri&#285;on de novaj redaktantoj ekde
...
'info_question_mots_cles' => '&#264;u vi deziras uzi la &#349;losilvortojn en via retejo&nbsp;?',
...
'info_recharger_page' => 'Bonvolu fre&#349;igi tiun &#265;i pa&#285;on post momento.',
...
'info_reglage_ldap' => '<MODIF>Opcioj: <B>&#284;ustigo de la LDAP &#349;argo</b>',
...
'info_sauvegarde_articles_sites_ref' => 'Konservi la artikolojn de la referencitaj retejoj',
...
'info_sauvegarde_sites_references' => 'Konservi la referencitajn retejojn',
'info_sauvegarde_type_documents' => 'Konservi la dokumentotipojn',
'info_sauvegarde_visites' => 'Konservi la vizitojn',
'info_selection_chemin_acces' => '<MODIF><b>Selektu</b> &#265;i-sube la alirvojon en la dosierujilo:',
'info_selection_un_seul_mot_cle' => 'Oni povas elekti nur<b>unu &#349;losilvorton</b> samtempe el tiu grupo.',
'info_signatures' => 'subskriboj',
'info_site' => 'Retejo',
'info_site_2' => 'retejo :',
'info_site_min' => 'retejo',
'info_site_propose' => 'Retejo proponita la :',
'info_site_reference_2' => 'Referencita retejo',
'info_site_syndique' => 'Tiu &#265;i retejo estas abonrilatigita...',
'info_site_valider' => 'Validigota retejo',
'info_site_web' => 'RETEJO :',
'info_sites' => 'retejoj',
'info_sites_lies_mot' => 'La referencitaj retejoj ligitaj al tiu &#265;i &#349;losilvorto',
'info_sites_proxy' => '<MODIF>Uzi prokuran servilon',
'info_sites_refuses' => 'La referencitaj retejoj',
'info_sites_trouves' => 'Trovitaj retejoj',
...
'info_statut_auteur_a_confirmer' => 'Konfirmenda registri&#285;o',
...
'info_statut_site_4' => 'Rubujen',
'info_statut_utilisateurs_1' => 'Defa&#365;lta statuso de la importitaj uzantoj',
'info_statut_utilisateurs_2' => '<MODIF>Elektu la statuton atribuotan al la personoj &#265;eestantaj en la LDAP-dosierujilo, kiam ili unuafoje konekti&#285;as. Poste vi povos modifi tiun valoron por &#265;iu a&#365;toro la&#365;kaze.',
'info_suivi_activite' => 'Superrigardo de la redakta agado',
'info_supprimer_mot' => 'forigi&nbsp;tiun&nbsp;vorton',
'info_surtitre' => 'Surtitolo:',
'info_syndication_integrale_1' => 'Via retejo proponas abonrilatajn dosierojn (vidu &laquo;&nbsp;<a href="@url@">@titre@</a>&nbsp;&raquo;).',
...
'info_terminer_installation' => '<MODIF>Vi povas nun fini la proceduron de la&#365;norma instalado.',
'info_texte' => 'Teksto',
...
'info_tout_site3' => 'La artikolo jam haveblas en tiu lingvo, sed modifoj estis poste aldonitaj al la referenca artikolo. Bonvolu &#285;isdatigi la tradukon.',
'info_tout_site4' => 'La artikolo haveblas en tiu lingvo, kaj la traduko estas &#285;isdatigita.',
'info_tout_site5' => 'Originala artikolo.',
'info_tout_site6' => '<b>Atentu&nbsp;:</b> nur la originalaj artikoloj estas afi&#349;ataj.
La tradukoj estas kunligitaj al la originalo, la&#365; koloro kiu indikas ties staton&nbsp;:',
...
'info_utilisation_spip' => 'Vi povas nun komenci uzi la asistatan publikigilon...',
...
'install_echec_annonce' => 'Certe la instalo estas malsukcesonta, a&#365; naskos ne funkciivan retejon...',
...
'item_accepter_inscriptions' => 'Akcepti la registri&#285;ojn',
...
'item_autoriser_documents_joints' => 'Permesi kunigo de dokumentoj al la artikoloj',
'item_autoriser_documents_joints_rubriques' => 'Permesi dokumentojn en la rubrikoj',
'item_autoriser_syndication_integrale' => 'Disponigi la tuton de la artikoloj en la abonrilataj dosieroj',
'item_bloquer_liens_syndiques' => 'Bloki la abonrilatigajn ligojn por validigo',
...
'item_choix_generation_miniature' => 'Generi a&#365;tomate la bildajn miniaturojn.',
...
'item_limiter_recherche' => 'Limigi la ser&#265;adon al informoj entenataj en via retejo',
...
'item_mots_cles_association_sites' => 'al referencitaj a&#365; abonrilatigitaj retejoj.',
'item_non' => 'Ne',
...
'item_non_autoriser_syndication_integrale' => 'Nur disponigi resumon',
'item_non_bloquer_liens_syndiques' => 'Ne bloki la ligojn rilatajn al abonrilato',
...
'item_non_limiter_recherche' => 'Etendi la ser&#265;adon al la enhavo de la referencitaj retejoj',
...
'item_non_utiliser_config_groupe_mots_cles' => 'Ne uzi la ampleksan konfiguron de la grupoj de &#349;losilvortoj',
...
'item_oui' => 'Jes',
'item_publier_articles' => 'Publikigi la artikolojn, kia ajn estas ilia publikig-dato.',
'item_reponse_article' => 'Respondo al la artikolo',
'item_utiliser_breves' => 'Uzi la fulm-informojn',
'item_utiliser_config_groupe_mots_cles' => 'Uzi la ampleksan konfiguron de la &#349;losilvortoj-grupoj',
...
'lien_reponse_site_reference' => 'Respondo al la referencita retejo:',
...
'logo_standard_rubrique' => '<MODIF>NORMA VINJETO DE LA RUBRIKOJ',
...
'module_texte_explicatif' => 'Vi povas inkludi la jenajn &#349;parvojojn en la skeletojn de via publika retejo. Ili estos a&#365;tomate tradukitaj en la diversajn lingvojn kiuj havas specifan lingvan dosieron.',
...
'ortho_mots_a_corriger' => 'korektenda vorto',
...
// R
'repertoire_plugins' => '<MODIF>Kromprogramo-indekso&nbsp;:',


// S
'statut_admin_restreint' => '(etrajta administranto)',
'syndic_choix_moderation' => 'Kion fari el la ligiloj devenontaj el tiu retejo&nbsp;?',
'syndic_choix_oublier' => 'Kion fari el la ligiloj, kiuj ne plu aperas en la abonrilatiga dosiero&nbsp;?',
'syndic_choix_resume' => 'Iuj retejoj disponigas la tutan tekston de la artikoloj. Kiam tiu &#265;i disponeblos, &#265;u vi deziras &#285;in abonrilatigi?&nbsp;:',
...
'syndic_options' => 'Abonrilato-elekto&nbsp;:',
...
'texte_acces_ldap_anonyme_1' => '<MODIF>Iuj LDAP-serviloj ne akceptas sennoman aliron. Tiukaze necesas difini ensalutilon por komenca aliro, ebligante poste ser&#265;i informojn en la adresaro. Plejofte tamen la sekvaj &#265;eloj povas resti malplenaj.',
'texte_admin_effacer_01' => 'Tiu ordono forvi&#349;as <i>la tutan</i> enhavon de la datenbazo,
...
NUR por retejo starigita per la sama versio de SPIP. Nepre ne "&nbsp;malplenigu la bazon&nbsp;" celante poste reinstali savkopion post &#285;isdatigo... Konsultu <a href="http://www.spip.net/fr_article1489.html">la dokumentaron de SPIP</a>.',
...
'texte_annuaire_ldap_1' => '<MODIF>Se vi havas aliron al adresaro (LDAP), vi povas uzi &#285;in por importi a&#365;tomate uzantojn sub SPIP.',
...
'texte_auteur_messagerie' => 'Tiu retejo povas konstante indiki la liston de la konektitaj redaktantoj. Tio ebligas al vi rekte inter&#349;an&#285;i mesa&#285;ojn. Vi povas decidi ne aperi en tiu listo (vi estas &laquo;&nbsp;nevidebla&nbsp;&raquo; al la aliaj uzantoj).',
'texte_auteur_messagerie_1' => 'Tiu retejo ebligas la inter&#349;an&#285;on de mesa&#285;oj kaj la estigon de privataj forumoj inter la partoprenantoj de la retejo. Vi povas decidi ne partopreni en tiuj inter&#349;an&#285;oj.',
...
'texte_commande_vider_tables_indexation' => 'Uzu tiun ordonon por malplenigi la indeksajn tabelojn uzatajn
...
'texte_config_groupe_mots_cles' => '&#264;u vi deziras aktivigi la ampleksan konfiguron de la &#349;losilvortoj,
   indikante ekzemple ke oni povas elekti po unu vorton en grupo,
   ke iu grupo estu ampleksa... ?',
'texte_connexion_mysql' => 'Konsultu la informojn donitajn de via gastiganto&nbsp;: vi devas trovi tie, se via gastiganto eltenas MySQL-on, la kodojn por konekti&#285;i al la MySQL-servilo.',
...
'texte_descriptif_petition' => '<MODIF>Priskribo de la subskriblisto',
...
'texte_liens_sites_syndiques' => '<MODIF>La ligoj el la abonrilatigitaj retejoj povas
...
'texte_moteur_recherche_active' => '<MODIF><b>La ser&#265;ilo estas aktiva.</b> Uzu tiun ordonon
...
'texte_mots_cles_dans_forum' => '<MODIF>&#264;u vi deziras permesi la uzadon de &#349;losilvortoj selekteblaj de la vizitantoj, en la forumoj de la publika spaco&nbsp;? (Atentu&nbsp;: tiu opcio estas relative kompleksa por &#285;uste uzi &#285;in.)',
...
'titre_page_upgrade' => 'Niveligo de SPIP',
...
// U
'utf8_convert_attendez' => 'Atendu kelkajn momentojn kaj fre&#349;igu tiun pa&#285;on.',
