...
'info_historique_lien' => 'Versionsentwicklung anzeigen',
...
'barre_aide_rac' => '<PLUS_UTILISE>Weitere Informationen &uuml;ber die typografischen K&uuml;rzel',
'icone_calendrier_messagerie' => '<PLUS_UTILISE>Kalender und Nachrichten',
'icone_etat_traductions' => '<PLUS_UTILISE>Stand der &Uuml;bersetzungen',
'icone_forum_interne' => '<PLUS_UTILISE>Internes Forum',
'icone_forums_petitions' => '<PLUS_UTILISE>Foren und Petitionen',
'icone_modifier_informations_personnelles' => '<PLUS_UTILISE>Pers&ouml;nliche Informationen bearbeiten',
...
'info_sur_site_public' => '<PLUS_UTILISE>[im &ouml;ffentlichen Bereich]',
'info_tous_redacteur' => '<PLUS_UTILISE>Ank&uuml;ndigung f&uuml;r alle Redakteure ',
'info_tout_site1' => '<PLUS_UTILISE>Sprache des Artikels.',
'item_administrateur' => '<PLUS_UTILISE>Administrator',
'item_efface' => '<PLUS_UTILISE>Gel&ouml;scht',
'item_premier' => '<PLUS_UTILISE>1.',
'item_redacteur' => '<PLUS_UTILISE>Redakteur',
'lien_modifer_date' => '<PLUS_UTILISE>Datum &auml;ndern',
'lien_rendez_vous' => '<PLUS_UTILISE>EINE VERABREDUNG',
'lien_rendez_vous_02' => '<PLUS_UTILISE>@total_messages@ VERABREDUNGEN',
'lien_test_format_image' => '<PLUS_UTILISE>Bildformate testen, f&uuml;r die Ihre Website Vorschaubilder generieren kann.',
'lnfo_liens' => '<PLUS_UTILISE>Links: ',
'login_identification' => '<PLUS_UTILISE>Identifikation',
'onglet_agenda' => '<PLUS_UTILISE>Kalender',
'onglet_bilan_traductions' => '<PLUS_UTILISE>Stand der &Uuml;bersetzungen',
'onglet_calendrier' => '<PLUS_UTILISE>Kalender',
'onglet_detail_traductions' => '<PLUS_UTILISE>Noch zu &uuml;bersetzen',
'onglet_langues' => '<PLUS_UTILISE>Sprachen',
'onglet_messagerie_personnelle' => '<PLUS_UTILISE>Pers&ouml;nliche Nachrichten',
'texte_bilan_traductions' => '<PLUS_UTILISE>Diese Grafik zeigt die &uuml;bersetzten Artikel als gr&uuml;ne Balken an, die roten Balken stehen f&uuml;r &Uuml;bersetzungen, die aktualisiert werden m&uuml;ssen.',
'texte_choix_langue_defaut' => '<PLUS_UTILISE>Bitte w&auml;hlen Sie die Standardsprache Ihrer Website sowie die Sprachversionen, die Sie Ihren Redakteuren anbieten m&ouml;chten.',
'texte_plan_trad' => '<PLUS_UTILISE>Diese Seite zeigt Ihnen den Stand der &Uuml;bersetzungen in der gew&auml;hlten Sprache an.          Sie sehen, welche Artikel gerade &uuml;bersetzt werden, welche &Uuml;bersetzungen aktualisiert werden m&uuml;ssen und welche Artikel noch nicht &uuml;bersetzt sind.',
'texte_plan_trad_en_cours' => '<PLUS_UTILISE>Dieses Symbol zeigt an, dass ein Artikel gerade &uuml;bersetzt wird, d.h. dass die &Uuml;bersetzung begonnen wurde aber noch nicht abgeschlossen ist. Klicken Sie auf das Symbol, um zur &Uuml;bersetzung zu gelangen. ',
'texte_plan_trad_modif' => '<PLUS_UTILISE>Dieses Symbol zeigt Ihnen, dass ein bereits &uuml;bersetzter Artikel modifiziert wurde. In diesem Fall ist es empfehlenswert, die &Uuml;bersetzung zu &uuml;berarbeiten um die &Auml;nderungen am Original in die anderen Sprachversionen aufzunehmen. ',
'texte_plan_trad_note' => '<PLUS_UTILISE>Auf dieser Seite werden nur ver&ouml;ffentlichte Artikel angezeigt.',
...
'titre_page_etat_traductions' => '<PLUS_UTILISE>Stand der &Uuml;bersetzungen'
