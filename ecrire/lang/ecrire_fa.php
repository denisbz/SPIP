...
'info_admin_gere_toutes_rubriques' => 'اين گرداننده سايت همه بخشها را اداره ميكند</b>.', # MODIF
...
'info_creation_paragraphe' => '(براى درست كردن پاراگراف، كافيست كه جاى خط ها را خالى بگذاريد)', # MODIF
...
'info_login_trop_court_car_pluriel' => 'لاگين شما بايد دست كم @nb@ كاراكتر داشته باشد.', # MODIF
'info_logos' => 'لوگوها',
'info_maximum' => ': حداكثر',
...
'info_obligatoire_02' => '[اجبارى]', # MODIF
...
'info_passe_trop_court_car_pluriel' => 'گذرواژه‌ي شما دست كم بايد @nb@ كاراكتر داشته باشد.', # MODIF
...
'info_site_web' => ':تارنمای سايت ', # MODIF
'info_sites' => 'سايت',
...
'info_texte_message' => ':متن پيامتان', # MODIF
...
'texte_en_cours_validation' => 'مقاله‌ها و خبرهاي زير براى انتشار پيشنهاد شده اند. ', # MODIF
...
'titre_langue_article' => 'زبان مقاله', # MODIF
'titre_langue_rubrique' => 'زبان بخش', # MODIF
