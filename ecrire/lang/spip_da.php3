...
'ical_texte_rss_articles' => '<NEW> The address of the backend file of the site\'s articles is:',
'ical_texte_rss_articles2' => '<NEW> Also, you can get backend files for the articles of each section of the site:',
'ical_texte_rss_breves' => '<NEW> Furthermore, there is a file containing the site\'s news items. By selecting a section number, you could get only the news items of that section.',
'ical_titre_js' => 'Javascript',
'ical_titre_mailing' => 'Postliste',
'ical_titre_rss' => '&laquo;Backend&raquo; fil',
...
'info_tout_site1' => '<NEW> Article\'s language',
'info_tout_site2' => '<NEW> The article has not been translated into this language.',
'info_tout_site3' => '<NEW> The article has been translated into this language, but some modifications had beed entered afterwards to the reference article. The translation requires updating.',
'info_tout_site4' => '<NEW> The article has been translated into this language, and the translation is up to date.',
'info_tout_site5' => '<NEW> Original article.',
'info_tout_site6' => '<NEW> <b>Warning:</b> only original articles are displayed.
...
'item_non_utiliser_moteur_recherche_forum' => '<NEW> Do not index the forums',
...
'item_utiliser_moteur_recherche_forum' => '<NEW> Index the forums',
...
'menu_aide_interface_perso_deconnecter' => 'Logge ud',
'menu_aide_interface_perso_simplifiee' => 'Forenklet / fuld brugergr&aelig;nseflade',
'menu_aide_messagerie' => 'Interne meddelelser',
...
'menu_aide_suivi_forum' => 'Forumvedligehold',
'menu_aide_suivi_forum_articles_postes' => 'Fremdaterede artikler',
'menu_aide_suivi_forum_configuration' => 'Webstedskonfiguration',
...
'menu_aide_suivi_forum_suivi' => 'Forumvedligehold',
...
// N
'navigateur_pas_redirige' => '<NEW> If your browser is not redirected, click here to continue.',
...
'titre_cadre_afficher_traductions' => 'Vis overs&aelig;ttelsesstatus for dette sprog.',
