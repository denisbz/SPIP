...
'info_langues' => 'Sjtens spr&aring;k',
...
'info_sauvegarde_articles_sites_ref' => '<NEW>Backup articles of referenced sites',
...
'info_statut_auteur' => 'Redakt&ouml;rens status:',
...
'info_statut_utilisateurs_1' => '<NEW>Default status of imported users',
...
// O
'onglet_repartition_actuelle' => '<NEW>now',
...
'text_article_propose_publication' => '<NEW>Article submitted for publication. Do not hesitate to give your opinion through the forum attached to this article (at the bottom of the page).',
...
'texte_admin_effacer_01' => '<NEW>This command deletes <i>all</i> the content of the database,
...
'texte_connexion_mysql' => '<NEW>Consult the information provided by your service provider. It should contain the connection codes for the SQL server.',
...
'texte_mise_a_niveau_base_1' => '<NEW>You have just updated SPIP files.
	Now you must upgrade the site\'s
	database.',
'texte_modifier_article' => 'Redigera artikeln:',
'texte_moteur_recherche_active' => '<NEW><b>The search engine is enabled.</b> use this command
...
'texte_mots_cles_dans_forum' => '<NEW>Do you wish to allow visitors to select keywords in the public site forums? (Warning: this option is rather intricate to use properly.)',
'texte_multilinguisme' => '<NEW>If you wish to manage articles in several languages, with a complicated navigation, you can add a language selection menu to the articles and/or the sections, according to the organisation of your site.',
'texte_multilinguisme_trad' => '<NEW>Also, you can enable a link management system amongst the different translations of an article.',
'texte_non_compresse' => '<NEW><i>uncompressed</i> (your server does not support this feature)',
'texte_non_fonction_referencement' => '<NEW>You can choose not to use this automated feature, and enter the elements concerning that site manually...',
...
'texte_recalcul_page' => '<NEW>If you want
...
irreversible.</b>',
'texte_sauvegarde' => '<NEW>Backup the content of the database',
'texte_sauvegarde_base' => '<NEW>Backup the database',
'texte_sauvegarde_compressee' => '<NEW>Backup will be stored in the uncompressed file @fichier@.',
...
'texte_vide' => '<NEW>empty',
'texte_vider_cache' => '<NEW>Empty the cache',
...
'titre_publication_articles_post_dates' => '<NEW>Publication of post dated articles',
