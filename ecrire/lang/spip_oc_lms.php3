...
'erreur_boucle_syntaxe2' => 'La bloca @milieu@ es incorrecta.',
...
'texte_auteur_messagerie' => 'Queste sit vos p&ograve;t indicar de contunh la tiera daus redactors connectats, &ccedil;&ograve; que vos permet d\'eschamjar daus messatges en directe (quora la messatjari&aacute; es desactivada &ccedil;ai subre, la quita tiera daus redactors es desactivada). Podetz decidir de pas apar&eacute;isser dins quela tiera (setz "invisible/a" per los autres utilizaires).',
