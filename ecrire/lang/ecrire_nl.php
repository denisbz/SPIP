...
'info_question_visiteur_ajout_document_forum' => 'Wilt u de bezoekers machtigen om samen te voegen documenten (beelden, klanken…) aan hun berichten van forums&nbsp;?',
'info_question_visiteur_ajout_document_forum_format' => 'Eventueel, de lijst van de documenten uitbreidingen aangeven toegelaten voor de forums(ex: gif, jpg, png, mp3).',
...
'item_autoriser_selectionner_date_en_ligne' => '<MODIF>De on-line datum van inzet van elk document kunnen selecteren',
...
'item_non_autoriser_selectionner_date_en_ligne' => '<MODIF>De datum van de documenten kunnen manueel niet veranderen',
...
'text_article_propose_publication' => '<MODIF>Artikel voorgelegd voor publicatie. Aarzel niet om je commentaar te geven via het forum dat bij het artikel is gevoegd (onderaan deze pagina).',
...
'texte_en_cours_validation' => '<MODIF>De artikels en berichten hieronder werden voorgesteld voor publicatie. Aarzel niet om je mening te geven via de forums die er op volgen.',
