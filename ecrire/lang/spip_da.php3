...
'barre_guillemets' => '<NEW> Entourer de &laquo; guillemets &raquo;',
'barre_guillemets_simples' => '<NEW> Entourer de &ldquo;guillemets de second niveau&rdquo;',
...
'bouton_radio_occidental' => '<MODIF> Vesteurop&aelig;isk alfabet (<tt>iso-8859-1</tt>): underst&oslash;ttes af alle browsere, men viser kun vesteurop&aelig;iske sprog (dansk, tysk, fransk, engelsk, ...).',
...
'bouton_radio_universel' => '<MODIF> Universelt alfabet (<tt>utf-8</tt>): viser alle sprog men er ikke underst&oslash;ttet af alle browsere endnu.',
...
'icone_edition_site' => '<MODIF> Rediger websted',
...
'info_afficher_visites' => '<MODIF> Vis bes&oslash;g for:',
...
'info_copyright_doc' => '<MODIF> For yderligere oplysninger bes&oslash;g webstedet <a href=\'http://www.spip.net/da\'>http://www.spip.net/da</a>.',
'info_cours_edition' => '<MODIF> Igang',
...
'login_non_securise' => '<MODIF> Advarsel, denne formular er ikke sikret.
...
'menu_aide_suivi_forum_configuration' => '<MODIF> N&oslash;jagtig konfiguration',
...
'texte_auteur_messagerie' => '<MODIF> Dette websted kan l&oslash;bende holde &oslash;je med, hvilke redakt&oslash;rer der er logget ind. Dette muligg&oslash;r realtidsudveksling af meddelelser (hvis udveksling af meddelser ovenfor er fravalgt, vedligeholdes oversigten over redakt&oslash;rer, der er online, heller ikke). Du kan v&aelig;lge ikke at v&aelig;re synlig i oversigten (du er s&aring; &laquo;usynlig&raquo; for andre brugere).',
...
'texte_jeu_caractere' => '<MODIF> Denne indstilling er nyttig, hvis dit websted viser andre alfabeter end det latinske alfabet (dvs. det &laquo;vestlige&raquo;) og dets afledninger. 
