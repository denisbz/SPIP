...
// C
'calendrier_synchro' => 'Si utilizas un software de agenda compatible <b>iCal</b> (Apple iCal, Mozilla Calendar, Ximian Evolution, KOrganizer...), puedes sincronizarlo con la actualidad editorial de este sitio.',
...
'menu_aide_suivi_forum_configuration' => 'Configuraci&oacute;n del sitio',
...
'texte_auteur_messagerie' => 'Este sitio puede indicarte permanentemente la lista de redactores y redactoras conectadas, lo que permite intercambiar mensajes en directo (cuando aqu&iacute; abajo la lista est&aacute; desactivada, la lista de redactores tambi&eacute;n lo est&aacute;). Adem&aacute;s, puedes decidir de no aparecer en la lista( est&aacute;s &laquo;invisible&raquo; para los dem&aacute;s usuarios).',
