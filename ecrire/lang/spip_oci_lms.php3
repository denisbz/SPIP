...
'barre_guillemets' => 'Environar emb de las &laquo; vergetas francesas &raquo;',
...
'info_config_suivi_explication' => 'Podetz recebre automaticament, per e-mail, las an&oacute;ncias pertochant l\'activitat editoriala de queu sit. Per qu&ograve; faire, vos podetz abonar a la mailing-list seguenta:',
...
'info_gauche_messagerie' => 'La messatjari&aacute; vos permet d\'eschamjar daus messatges entre redactors, de servar de las n&ograve;tas per se remembrar (per v&ograve;stre usatge personau) o d\'afichar de las an&oacute;ncias sus la pagina d\'acuelh de l\'espaci privat (se setz administrator/tritz).',
...
'info_non_envoi_annonce_dernieres_nouveautes' => 'SPIP p&ograve;t mandar, regularament, l\'an&oacute;ncia de las darrieras novetats dau sit
 (articles e brevas publicadas recentament).',
...
'info_symbole_jaune' => 'Lo simbeu <B>jaune</b> marca una <B>an&oacute;ncia per tots los redactors </b>: los administrators la p&ograve;den modificar, chasque redactor la p&ograve;t veire.',
...
'lien_nouvelle_annonce' => 'AN&Oacute;NCIA NOVELA',
...
'texte_message_edit' => 'Atencion: queste messatge, chasque redactor lo p&ograve;t veire, e chasque administrator dau sit lo p&ograve;t modificar. Utilizatz las an&oacute;ncias nonm&agrave;s per expausar daus eveniments importants de la vida dau sit.',
