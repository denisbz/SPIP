...
'avis_connexion_echec_1' => '<MODIF>La connexion au servior SQL a mal capitat.',
'avis_connexion_echec_2' => 'Tornatz v&egrave;rs la pagina anteriora, e verificatz las informacions qu\'av&egrave;tz fornias.',
'avis_connexion_echec_3' => '<MODIF><b>N.B.</b> Sus ben de serviors, dev&egrave;tz <b>demandar</b> qu\'activen v&ograve;stre acc&egrave;s v&egrave;rs la basa SQL avans de la poer utilizar. Se vos po&egrave;tz pas connectar, verificatz qu\'aiatz ben realizat aquel procediment.',
...
'avis_site_syndique_probleme' => '<MODIF>Atencion: la sindicacion d\'aquel sit a rescontrat un probl&egrave;ma; lo sist&egrave;ma es doncas interromput temporariament. Verificatz l\'adrei&ccedil;a dau fichier de sindicacion d\'aquel sit (<b>@url_syndic@</b>), e tornatz assajar de recuperar las informacions.',
...
'ical_info2' => '<MODIF>Per tenir mai d\'informacions sobre aquelas tecnicas, esitetz pas de consultar <a href="@spipnet@">la documentacion d\'SPIP</a>.',
...
'info_option_email' => '<MODIF>Quand un vesitaire dau sit manda un messatge n&ograve;u au forum
...
'text_article_propose_publication' => '<MODIF>Article prepausat per la publicacion. Esitetz pas de donar v&ograve;stre av&iacute;s gr&agrave;cias au forum estachat a aquel article (en bas de pagina).',
...
'texte_connexion_mysql' => '<MODIF>Consultatz las informacions que v&ograve;stre auberjaor forn&iacute;s: i dev&egrave;tz trobar, se v&ograve;stre auberjaor sup&ograve;rta SQL, los c&ograve;des de connexion au servior SQL.',
...
'texte_en_cours_validation' => '<MODIF>Se prepausa de publicar los articles e br&egrave;vas &ccedil;ai sos. Esitetz pas per donar v&ograve;stre av&iacute;s gr&agrave;cias als forums que i son estachats.',
...
'texte_utilisation_moteur_syndiques' => '<MODIF>Quand utilizatz lo cerchaor integrat 
