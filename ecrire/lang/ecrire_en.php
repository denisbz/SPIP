...
'info_table_prefix' => 'The data of this site is held in tables named <tt><b>spip</b>_articles</tt>, <tt><b>spip</b>_rubriques</tt>, etc. If you are installing several sites in the same database, you can change the prefix of the table names (N.B. Use only unaccented, lower-case letters.).',
