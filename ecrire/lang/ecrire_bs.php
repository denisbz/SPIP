...
'bouton_forum_petition' => '<MODIF>PETICIJA & FORUM',
...
'bouton_radio_sauvegarde_compressee' => '<MODIF>Snimiti sa kompresijom pod @fichier@',
'bouton_radio_sauvegarde_non_compressee' => '<MODIF>Snimiti bez  kompresije pod @fichier@',
...
'entree_chemin_acces' => '<MODIF><b>Unijeti</b> putanju pristupa:',
...
'entree_titre_obligatoire' => '<MODIF><b>Naslov</b> [Obavezno]<br />',
...
'icone_evolution_visites' => '<MODIF>Nivo posjeta <br />@visites@ posjete',
...
'info_activer_forum_public' => '<MODIF><i>Da bi ste aktivirali javne forume, izaberite njihov standardni nacin moderacije</i>',
...
'info_connexion_base' => '<MODIF>Druga etapa: <b>Pokusaj konekcije sa bazom</b>',
...
'info_connexion_mysql' => '<MODIF>Prva etapa: <b>Vasa SQL konekcija</b>',
...
'info_creation_rubrique' => '<MODIF>Prije nego mozete pisati clanke,<br /> morate kreirati najmanje jednu rubriku.<br />',
'info_creation_tables' => '<MODIF>Cetvrta etapa: <b>Kreiranje tabela baze</b>',
'info_creer_base' => '<MODIF><b>Kreirati</b> novu bazu podataka:',
...
'info_derniere_etape' => '<MODIF>Posljednja etapa: <b>Zavrseno je!',
...
'info_informations_personnelles' => '<MODIF>Peta etapa: <b>Licne informacije</b>',
...
'info_mise_a_niveau_base' => '<MODIF>nadogradnja vase SQL baze',
...
'info_option_email' => '<MODIF>Kada posjetioc sranice postavi novu poruku u forum vezan za neki clanak, autori clanka mogu biti o tome upozoreni putem e-maila. Zelite li koristiti ovu opciju?',
...
'info_par_nombre_article' => '<MODIF>(po broju clanaka)',
...
'info_reglage_ldap' => '<MODIF>Opcije: namijestanje LDAP importa</b>',
'info_renvoi_article' => '<MODIF><b>Preusmjerenje.</b> Ovaj clanak se preusmjerava na stranicu:',
...
'info_sauvegarde_reussi_02' => '<MODIF>Baza je pohranjena u @archive@. Mozete se',
...
'info_statut_auteur' => '<MODIF>Status ovog autora:',
...
'logo_groupe' => '<NEW>LOGO DE CE GROUPE',
...
'texte_creer_rubrique' => '<MODIF>Prije pisanja clanaka,<br /> trebate kreirati rubriku.',
...
'texte_syndication' => '<MODIF>Moguce je automatsko otkrivanje spiska novosti, ako web stranica to dozvoljava. Zato trebate aktivirati sindikaciju\\tab <blockquote><i>Odredjeni hosting servisi dezaktiviraju tu funkciju; u tom slucaju ne mozete koristiti sindikaciju sadrzaja na vasoj stranici.</i></blockquote>',
...
'texte_titre_obligatoire' => '<MODIF><b>Naslov</b> [Obavezan]',
...
'titre_cadre_signature_obligatoire' => '<MODIF><b>Potpis</b>  [Obavezno]<br />',
...
'trad_deja_traduit' => '<MODIF>Ovaj clanak je vec prevod prethodnog clanka.',
