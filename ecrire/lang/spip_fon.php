...
'icone_etat_traductions' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Situa&ccedil;&atilde;o das tradu&ccedil;&otilde;es',
'icone_evolution_visites_2' => '<NEW><pLUS_UTILISE><MAIS_UTILIZADO>',
'icone_forum_administrateur' => 'kp&eacute;kp&eacute; g&aacute;n l&#603; t&#596;n',
'icone_forum_interne' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>F&oacute;rum interno',
...
'icone_modifier_informations_personnelles' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Modificar as suas informa&ccedil;&otilde;es pessoais',
...
'info_dans_espace_prive' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>[no espa&ccedil;o privado]',
...
'info_en_test_1' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>&nbsp;(em&nbsp;teste)',
'info_en_test_2' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>(em teste)',
...
'info_langue_defaut' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>L&iacute;ngua por defeito&nbsp;:',
'info_langue_interface' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>L&iacute;ngua da interface',
'info_langue_principale' => 'Gb&egrave;t&aacute; gblogbloj&iacute; &#596; t&#596;n',
'info_langues_proposees' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>L&iacute;nguas propostas&nbsp;:',
'info_largeur_vignette' => 'j&iacute;jl&#603;m&#603;',
'info_les_auteurs_1' => 'gb&#596;n@',
'info_lettre_heures' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>H',
'info_lien' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>v&iacute;nculo',
...
'info_nouveau' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>(Novo)',
...
'info_remplacer_vignette_defaut' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Substituir a vinheta por defeito por um logotipo personalizado&nbsp;:',
...
'info_sur_site_public' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>[no s&iacute;tio p&uacute;blico]',
...
'info_tous_redacteur' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>An&uacute;ncios a todos os redactores',
'info_tous_resultats_enregistres' => '[y&eacute; wl&iacute; x&oacute;gb&egrave; l&#603; b&iacute; h&#603;n]',
'info_tout_afficher' => 'Xl&#603; b&iacute;',
'info_tout_site1' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE><NEW>Langue de l\'article.',
...
'item_administrateur' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Administrador',
'item_breve_proposee' => '&#598;&#596; x&oacute; kl&eacute;w&uacute;n',
'item_efface' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Apagado',
...
'item_premier' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>1&deg;',
'item_redacteur' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Redactor',
...
'lien_modifer_date' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Modificar a data',
...
'lien_rendez_vous' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>UM ENCONTRO',
'lien_rendez_vous_02' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>@total_messages@ ENCONTRO',
'lien_repondre_message' => 'y&iacute;gbj&egrave; n&uacute; w&#603;n &eacute; l&#596;',
'lien_supprimer' => 'S&ugrave;ns&ugrave;n',
'lien_test_format_image' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Testar os formatos de imagem que este s&iacute;tio pode utilizar para criar vinhetas',
...
'lnfo_liens' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>la&ccedil;os',
...
'login_identification' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>identifica&ccedil;&atilde;o',
...
'onglet_agenda' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Agenda',
'onglet_auteur' => 'ny&#596;wl&aacute;nt&#596; &#596; ',
'onglet_bilan_traductions' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Balan&ccedil;o das tradu&ccedil;&otilde;es',
'onglet_calendrier' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Calend&aacute;rio',
'onglet_contenu_site' => 'gbl&ograve;gbl&ograve;j&iacute; s&iacute;n &agrave;&#598;&#596;m&#603; ',
'onglet_detail_traductions' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Os artigos a traduzir',
...
'onglet_langues' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>L&iacute;nguas',
'onglet_messagerie' => 'w&#603;ngb&aacute;v&iacute;',
'onglet_messagerie_personnelle' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Correio pessoal',
...
'texte_bilan_traductions' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Neste gr&aacute;fico, as barras verdes representam os artigos traduzidos e actualizados, as barras vermelhas as tradu&ccedil;&otilde;es que devem ser actualizadas.',
'texte_choix_langue_defaut' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Favor escolher a seguir a l&iacute;ngua por defeito do seu s&iacute;tio, assim como as l&iacute;nguas que ser&atilde;o propostas aos redactores.',
...
'texte_plan_trad' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Esta p&aacute;gina permite-lhe visualizar o estado das tradu&ccedil;&otilde;es para a l&iacute;ngua escolhida. 
...
'texte_plan_trad_en_cours' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Este s&iacute;mbolo indica que um artigo est&aacute; em curso de tradu&ccedil;&atilde;o&nbsp;: isto quer dizer que uma tradu&ccedil;&atilde;o 
  foi come&ccedil;ada mas n&atilde;o foi ainda publicada.Clique no s&iacute;mbolo para aceder
 &agrave; tradu&ccedil;&atilde;o.',
'texte_plan_trad_modif' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Este s&iacute;mbolo indica que as modifica&ccedil;&otilde;es foram feitas num 
...
'texte_plan_trad_note' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Nota&nbsp;: s&oacute; os artigos publicados est&atilde;o exibidos nesta p&aacute;gina.',
...
'titre_articles_populaires' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Artigos mais populares',
'titre_articles_visites' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Artigos mais visitados',
...
'titre_page_admin_vider' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Manuten&ccedil;&atilde;o t&eacute;cnica : gest&atilde;o do cache',
'titre_page_etat_traductions' => '<NEW><pLUS_UTILISE><NEW><pLUS_UTILISE>Estado das tradu&ccedil;&otilde;es',
