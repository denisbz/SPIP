...
'erreur_boucle_syntaxe' => 'Sintaxi incorrecte del bucle',
...
'info_erreur_squelette' => 'Error en el lloc Web',
...
'info_historique_lien' => 'Mostrar l\'hist&ograve;ric',
...
'menu_aide_suivi_forum_configuration' => 'Configuraci&oacute; del lloc',
...
// PLUS_UTILISE
'avis_erreur_cookie' => '<PLUS_UTILISE> problema de cookie',
'barre_aide_rac' => '<PLUS_UTILISE>Per saber m&eacute;s coses de les dreceres tipogr&agrave;fiques',
'calendrier_synchro_lien' => '<PLUS_UTILISE>Recuperar el fitxer <i>iCal</i>',
'calendrier_synchro_prive' => '<PLUS_UTILISE>El seg&uuml;ent calendari, d\'&uacute;s estrictament personal, us informa de l\'activitat editorial privada d\'aquest lloc (feines i cites personals, articles i breus proposats...).',
'calendrier_synchro_public' => '<PLUS_UTILISE>El seg&uuml;ent calendari permet seguir l\'activitat de l\'espai p&uacute;blic d\'aquest lloc (articles i breus publicats).',
'calendrier_synchro_sync' => '<PLUS_UTILISE>Sincronitzar el fitxer <i>iCal</i><br> (Mozilla Calendar, Apple iCal...)',
'icone_calendrier_messagerie' => '<PLUS_UTILISE>Agenda i missatgeria',
'icone_etat_traductions' => '<PLUS_UTILISE>Estat de les traduccions',
'icone_forum_interne' => '<PLUS_UTILISE>F&ograve;rum intern',
'icone_forums_petitions' => '<PLUS_UTILISE>F&ograve;rums i peticions',
'icone_modifier_informations_personnelles' => '<PLUS_UTILISE>Modificar les seves informacions personals',
'info_dans_espace_prive' => '<PLUS_UTILISE>[a l\'espai privat]',
'info_en_test_1' => '<PLUS_UTILISE>&nbsp;(en prova)',
'info_en_test_2' => '<PLUS_UTILISE>(en prova)',
'info_langue_defaut' => '<PLUS_UTILISE>Idioma per defecte:',
'info_langue_interface' => '<PLUS_UTILISE>Idioma de la interf&iacute;cie',
'info_langues_proposees' => '<PLUS_UTILISE>Lleng&uuml;es proposades:',
'info_lettre_heures' => '<PLUS_UTILISE>:',
'info_lien' => '<PLUS_UTILISE>enlla&ccedil;:',
'info_nouveau' => '<PLUS_UTILISE>(Nou)',
'info_remplacer_vignette_defaut' => '<PLUS_UTILISE>Substituir la icona per defecte per un logotip personalitzat:',
'info_sur_site_public' => '<PLUS_UTILISE>[en el lloc p&uacute;blic]',
'info_tous_redacteur' => '<PLUS_UTILISE>Avisos a tots els redactors',
'info_tout_site1' => '<PLUS_UTILISE>Llengua de l\'article.',
'item_administrateur' => '<PLUS_UTILISE>Administrador',
'item_efface' => '<PLUS_UTILISE>Suprimit',
'item_premier' => '<PLUS_UTILISE>1r',
'item_redacteur' => '<PLUS_UTILISE>Redactor',
'lien_modifer_date' => '<PLUS_UTILISE>Modificar la data',
'lien_rendez_vous' => '<PLUS_UTILISE>UNA CITA',
'lien_rendez_vous_02' => '<PLUS_UTILISE>@total_messages@ CITES',
'lien_test_format_image' => '<PLUS_UTILISE>Provar els formats d\'imatge que aquest lloc pot utilitzar per crear vinyetes',
'lnfo_liens' => '<PLUS_UTILISE>enlla&ccedil;os:',
'login_identification' => '<PLUS_UTILISE>identificaci&oacute;',
'onglet_agenda' => '<PLUS_UTILISE>Agenda',
'onglet_bilan_traductions' => '<PLUS_UTILISE>Resum de les traduccions',
'onglet_calendrier' => '<PLUS_UTILISE>Calendari',
'onglet_detail_traductions' => '<PLUS_UTILISE>Els articles a traduir',
'onglet_langues' => '<PLUS_UTILISE>Idiomes',
'onglet_messagerie_personnelle' => '<PLUS_UTILISE>Missatgeria personal',
'texte_bilan_traductions' => '<PLUS_UTILISE>En aquest gr&agrave;fic, les barres verdes representen els articles tradu&iuml;ts i posats al dia, les barres vermelles corresponen als articles que s\'han d\'actualitzar.',
'texte_choix_langue_defaut' => '<PLUS_UTILISE>Trieu de les d\'ac&iacute; baix la llengua per defecte de la vostra web, aix&iacute; com les llengues que ser&agrave;n proposades als redactors.',
'texte_plan_trad' => '<PLUS_UTILISE>Aquesta p&agrave;gina permet visualitzar l\'estat de les traduccions per la llengua escollida. 
  ...
  aix&iacute; com els articles que encara no han estat tradu&iuml;ts.   ',
'texte_plan_trad_en_cours' => '<PLUS_UTILISE>Aquest s&iacute;mbol indica que un article es troba en proc&eacute;s de traducci&oacute;: aix&ograve; vol dir que s\'ha comen&ccedil;at una traducci&oacute; per&ograve; que encara no s\'ha publicat. Cliqueu en el s&iacute;mbol per accedir a la traducci&oacute;.',
'texte_plan_trad_modif' => '<PLUS_UTILISE>Aquest s&iacute;mbol ens indica que s\'han fet modificacions a un article ja tradu&iuml;t.
  En aquest cas, es aconsellable d\'actualitzar la traducci&oacute; en funci&oacute; de les modificacions que s\'han fet a l\'article original. ',
'texte_plan_trad_note' => '<PLUS_UTILISE>Nota: nom&eacute;s els articles publicats es mostren en aquesta p&agrave;gina.',
'titre_articles_populaires' => '<PLUS_UTILISE>Articles m&eacute;s populars',
'titre_articles_visites' => '<PLUS_UTILISE>Articles m&eacute;s visitats',
'titre_page_admin_vider' => '<PLUS_UTILISE>Manteniment t&egrave;cnic: gesti&oacute; de la cach&eacute;',
'titre_page_etat_traductions' => '<PLUS_UTILISE>Estat de les traduccions'
