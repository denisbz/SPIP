...
'bouton_effacer_statistiques' => '<NEW><NEW>Effacer les statistiques',
...
'config_choix_base_sup' => '<NEW><NEW>indiquer une base sur ce serveur',
'config_erreur_base_sup' => '<NEW><NEW>SPIP n\'a pas acc&egrave;s &agrave; la liste des bases accessibles',
'config_info_base_sup' => '<NEW><NEW>Si vous avez d\'autres bases de donn&eacute;es &agrave; interroger &agrave; travers SPIP, avec son serveur SQL ou avec un autre, le formulaire ci-dessous, vous permet de les d&eacute;clarer. Si vous laissez certains champs vides, les identifiants de connexion &agrave; la base principale seront utilis&eacute;s.',
'config_info_base_sup_disponibles' => '<NEW><NEW>Bases suppl&eacute;mentaires d&eacute;j&agrave; interrogeables:',
...
'config_titre_base_sup' => '<NEW><NEW>D&eacute;claration d\'une base suppl&eacute;mentaire',
'config_titre_base_sup_choix' => '<NEW><NEW>Choisissez une base suppl&eacute;mentaire',
...
'info_connexion_base_donnee' => '<NEW><NEW>Connexion &agrave; votre base de donn&eacute;es',
...
'info_question_vignettes_referer' => '<NEW><NEW>Lorsque vous consultez les statistiques, vous pouvez visualiser des aper&ccedil;us des sites d\'origine des visites',
'info_question_vignettes_referer_non' => '<NEW><NEW>Ne pas afficher les captures des sites d\'origine des visites',
'info_question_vignettes_referer_oui' => '<NEW><NEW>Afficher les captures des sites d\'origine des visites',
...
'info_sauvegarde_rubrique_reussi' => '<NEW><NEW>Les tables de la rubrique @titre@ ont &eacute;t&eacute; sauvegard&eacute;e dans @archive@. Vous pouvez',
...
'info_taille_maximale_images' => '<NEW><NEW>SPIP va tester la taille maximale des images qu\'il peut traiter (en millions de pixels).<br /> Les images plus grandes ne seront pas r&eacute;duites.',
...
'install_select_type_db' => '<NEW><NEW>Indiquer le type de base de donn&eacute;es&nbsp;:',
'install_select_type_mysql' => 'MySQL',
'install_select_type_pgsql' => 'PostgreSQL',
'install_select_type_sqlite2' => 'SQLite 2',
'install_select_type_sqlite3' => 'SQLite 3',
'install_serveur_hebergeur' => '<NEW><NEW>Serveur de base de donn&eacute;es attribu&eacute; par l\'h&eacute;bergeur',
'install_table_prefix_hebergeur' => 'Prefisso della tabella attribuito dal provider:',
'install_types_db_connus' => '<NEW><NEW>SPIP sait utiliser <b>MySQL</b> (le plus r&eacute;pandu), <b>PostgreSQL</b> et <b>SQLite</b>.',
'install_types_db_connus_avertissement' => '<NEW><NEW>Attention&nbsp;: plusieurs plugins ne fonctionnent qu\'avec MySQL',
...
'plugin_charge_paquet' => '<NEW><NEW>Chargement du paquet @name@',
'plugin_erreur_charger' => '<NEW><NEW>erreur&nbsp;: impossible de charger @zip@',
'plugin_erreur_droit1' => '<NEW><NEW>Le r&#233;pertoire <code>@dest@</code> n\'est pas accessible en &#233;criture.',
'plugin_erreur_droit2' => '<NEW><NEW>Veuillez v&#233;rifier les droits sur ce r&#233;pertoire (et le cr&#233;er le cas &#233;ch&#233;ant), ou installer les fichiers par FTP.',
'plugin_erreur_zip' => '<NEW><NEW>echec pclzip&nbsp;: erreur @status@',
...
'plugin_info_automatique1' => '<NEW><NEW>Si vous souhaitez autoriser l\'installation automatique des plugins, veuillez&nbsp;:',
'plugin_info_automatique2' => '<NEW><NEW>cr&#233;er un r&#233;pertoire <code>@rep@</code>&nbsp;;',
'plugin_info_automatique3' => '<NEW><NEW>v&#233;rifier que le serveur est autoris&#233; &#224; &#233;crire dans ce r&#233;pertoire.',
'plugin_info_automatique_creer' => '<NEW><NEW>&#224; cr&#233;er &#224; la racine du site.',
'plugin_info_automatique_exemples' => '<NEW><NEW>exemples&nbsp;:',
'plugin_info_automatique_ftp' => '<NEW><NEW>Vous pouvez installer des plugins, par FTP, dans le r&#233;pertoire <tt>@rep@</tt>',
'plugin_info_automatique_lib' => '<NEW><NEW>Certains plugins demandent aussi &#224; pouvoir t&#233;l&#233;charger des fichiers dans le r&#233;pertoire <code>lib/</code>, &#224; cr&#233;er le cas &#233;ch&#233;ant &#224; la racine du site.',
'plugin_info_automatique_liste' => '<NEW><NEW>Vos listes de plugins&nbsp;:',
'plugin_info_automatique_liste_officielle' => '<NEW><NEW>les plugins officiels',
'plugin_info_automatique_liste_update' => '<NEW><NEW>Mettre &#224; jour les listes',
'plugin_info_automatique_ou' => '<NEW><NEW>ou...',
'plugin_info_automatique_select' => '<NEW><NEW>S&#233;lectionnez ci-dessous un plugin&nbsp;: SPIP le t&#233;l&#233;chargera et l\'installera dans le r&#233;pertoire <code>@rep@</code>&nbsp;; si ce plugin existe d&#233;j&#224;, il sera mis &#224; jour.',
'plugin_info_telecharger' => '<NEW><NEW>&#224; t&#233;l&#233;charger depuis @url@ et &#224; installer dans @rep@',
'plugin_librairies_installees' => '<NEW><NEW>Librairies install&#233;es',
'plugin_necessite_lib' => '<NEW><NEW>Ce plugin n&#233;cessite la librairie @lib@',
...
'plugin_source' => '<NEW><NEW>source:&nbsp;',
'plugin_titre_automatique' => '<NEW><NEW>Installation automatique',
'plugin_titre_automatique_ajouter' => '<NEW><NEW>Ajouter des plugins',
'plugin_zip_active' => '<NEW><NEW>Continuez pour l\'activer',
'plugin_zip_adresse' => '<NEW><NEW>indiquez ci-dessous l\'adresse d\'un fichier zip de plugin &#224; t&#233;l&#233;charger, ou encore l\'adresse d\'une liste de plugins.',
'plugin_zip_adresse_champ' => '<NEW><NEW>Adresse du plugin ou de la liste&nbsp;',
'plugin_zip_content' => '<NEW><NEW>Il contient les fichiers suivants (@taille@),<br />pr&#234;ts &#224; installer dans le r&#233;pertoire <code>@rep@</code>',
'plugin_zip_installe_finie' => '<NEW><NEW>Le fichier @zip@ a &#233;t&#233; d&#233;compact&#233; et install&#233;.',
'plugin_zip_installe_rep_finie' => '<NEW><NEW>Le fichier @zip@ a &#233;t&#233; d&#233;compact&#233; et install&#233; dans le r&#233;pertoire @rep@',
'plugin_zip_installer' => '<NEW><NEW>Vous pouvez maintenant l\'installer.',
'plugin_zip_telecharge' => '<NEW><NEW>Le fichier @zip@ a &#233;t&#233; t&#233;l&#233;charg&#233;',
'plugins_actifs' => '<NEW><NEW>@count@ plugins activ&#233;s.',
'plugins_compte' => '<NEW><NEW>@count@ plugins',
'plugins_disponibles' => '<NEW><NEW>@count@ plugins disponibles.',
'plugins_erreur' => '<NEW><NEW>Erreur dans les plugins : @plugins@',
'plugins_liste' => 'Elenco dei plugin',
'plugins_vue_hierarchie' => '<NEW><NEW>Hi&eacute;rarchie',
...
'sauvegarde_fusionner_depublier' => '<NEW><NEW>D&eacute;publier les objets fusionn&eacute;s',
...
'texte_admin_effacer_stats' => '<NEW><NEW>Cette commande efface toutes les donn&eacute;es li&eacute;es aux statistiques de visite du site, y compris la popularit&eacute; des articles.',
...
'texte_admin_tech_04' => '<NEW><NEW>Dans un but de fusion avec une autre base, vous pouvez limiter la sauvegarde &agrave; la rubrique: ',
...
'texte_effacer_statistiques' => '<NEW><NEW>Effacer les statistiques',
