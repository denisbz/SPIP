...
'avis_connexion_echec_3' => '<MODIF><B>N.B.</b> Bei vielen Providern m&uuml;ssen Sie Ihre Datenbank ausdr&uuml;cklich <B>aktivieren lassen</b> um sie nutzen zu k&ouml;nnen. Wenn die Verbindung wieder fehlschl&auml;gt, stellen Sie bitte sicher, dass Ihre Datenbank aktiviert wurde.',
...
'avis_espace_interdit' => '<MODIF><B>Gesperrter Bereich</b><p>SPIP ist bereits installiert.',
...
'dirs_preliminaire' => '<MODIF>Vorbereitung: <B>Berechtigungen einstellen</B>',
'dirs_probleme_droits' => '<b>Problem mit den Berechtigungen</b>',
'dirs_repertoires_absents' => '<MODIF><B>Folgende Verzeichnisse wurden nicht gefunden: <ul>@bad_dirs@.</ul> </b>
...
'dirs_repertoires_suivants' => '<MODIF><B>In die folgenden Verzeichnisse kann nicht geschrieben werden: <ul>@bad_dirs@.</ul> </B>
...
'forum_lien_hyper' => '<MODIF><B>Hyperlink</B> (optional)',
...
'forum_qui_etes_vous' => '<MODIF><B>Wer sind Sie?</B> (optional)',
...
'icone_aide_ligne' => '<MODIF>Online-Hilfe',
...
'icone_configuration_site' => '<MODIF>Website-Konfiguration',
...
'icone_statistiques_visites' => '<MODIF>Statistiken',
...
'icone_visiter_site' => '<MODIF>Website ansehen',
...
'info_connexion_ldap_ok' => '<MODIF>Die Verbindung zum LDAP-Verzeichnis wurde hergestellt.</b><P> Sie k&ouml;nnen mit dem n&auml;chsten Schritt fortfahren.',
...
'info_gauche_admin_effacer' => '<MODIF><B>Diese Seite ist nur f&uuml;r den Verantwortlichen der Website zug&auml;nglich.</b><P>Sie erlaubt bestimmte technische Wartungsvorg&auml;nge auszul&ouml;sen. F&uuml;r manche Funktionen ist die Authentifizierung per FTP Voraussetzung.',
'info_gauche_admin_tech' => '<MODIF><B>Diese Seite ist nur f&uuml;r den Verantwortlichen der Website zug&auml;nglich.</b><P>Sie erlaubt bestimmte technische Wartungsvorg&auml;nge auszul&ouml;sen. F&uuml;r manche Funktionen ist die Authentifizierung per FTP Voraussetzung.',
'info_gauche_admin_vider' => '<MODIF><B>Diese Seite ist nur f&uuml;r den Verantwortlichen der Website zug&auml;nglich.</b><P>Sie erlaubt bestimmte technische Wartungsvorg&auml;nge auszul&ouml;sen. F&uuml;r manche Funktionen ist die Authentifizierung per FTP Voraussetzung.',
...
'info_nexen_2' => 'Das Verzeichnis <tt>ecrire/data/</tt> muss gesch&uuml;tzt werden mit ',
...
'info_tout_site1' => 'Sprache des Artikels.',
...
'menu_aide_messagerie_utilisateurs' => 'Nachrichten zwischen Benutzern',
...
'texte_bilan_traductions' => 'Diese Grafik zeigt die &uuml;bersetzten Artikel als gr&uuml;ne Balken an, die roten Balken stehen f&uuml;r &Uuml;bersetzungen, die aktualisiert werden m&uuml;ssen.',
...
'texte_date_publication_anterieure' => '<MODIF>DATUM EINER FR&Uuml;HEREN VER&Ouml;FFENTLICHUNG',
'texte_date_publication_anterieure_nonaffichee' => 'Kein Datum einer fr&uuml;heren Ver&ouml;ffentlichung anzeigen.',
'texte_date_publication_article' => '<MODIF>VER&Ouml;FFENTLICHT AM:',
...
'texte_documents_joints' => '<MODIF>Sie k&ouml;nnen die Zuordnung von Dokumenten (Office-Dokumente, Bilder, Multimedia-Dateien, etc.) zu Artikeln und/oder Rubriken erlauben. Diese Dokumente k&ouml;nnen anschliessend innerhalb von Artikeln oder separat angezeigt werden.<p>',
...
'texte_fichier_authent' => '<MODIF>Soll SPIP die Dateien <tt>.htpasswd</tt> und <tt>.htpasswd-admin</tt> im Verzeichnis <tt>ecrire/data/</tt> anlegen?</b><p> Mit diesen Dateien k&ouml;nnen Sie den Zugang zu anderen Bereichen Ihrer Website (z.B. externe Logfile-Auswertungen) auf Redakteure und Administratoren beschr&auml;nken.<p>Wenn Sie diese M&ouml;glickeit nicht nutzen, k&ouml;nnn Sie hier die Grundeinstellung (Dateien werden nicht angelegt) beibehalten.',
...
'texte_nouvelle_version_spip_2' => '<MODIF>Diese Version erfordert eine weiter gehende Aktualisierung Ihres Systems als bisherige SPIP-Updates.
...
'texte_plan_trad' => 'Diese Seite zeigt Ihnen den Stand der &Uuml;bersetzungen in der gew&auml;hlten Sprache an.          Sie sehen, welche Artikel gerade &uuml;bersetzt werden, welche &Uuml;bersetzungen aktualisiert werden m&uuml;ssen und welche Artikel noch nicht &uuml;bersetzt sind.',
'texte_plan_trad_en_cours' => 'Dieses Symbol zeigt an, dass ein Artikel gerade &uuml;bersetzt wird, d.h. dass die &Uuml;bersetzung begonnen wurde aber noch nicht abgeschlossen ist. Klicken Sie auf das Symbol, um zur &Uuml;bersetzung zu gelangen. ',
...
'texte_requetes_echouent' => '<MODIF><b>Wenn manche SQL-Befehle ohne ersichtlichen Grund systematisch fehlschlagen, kann es an einer besch&auml;digten Datenbank liegen.</b><p>
...
'titre_connexion_ldap' => '<MODIF>Optionen: <B>LDAP-Verbindung</b>',
...
'titre_forum' => '<MODIF>Internes Forum',
