...
'ical_texte_rss' => '<MODIF> Que podetz sindicar las nautats d\'aqueth sit dens tot legider de fichi&egrave;rs en format XML/RSS (Rich Site Summary). Qu\'ei tanben lo format qui permet a SPIP de legir las nautats publicadas dens autes sits en utilizar un format d\'escambi compatible. ',
...
'titre_cadre_afficher_traductions' => '<MODIF> Afichar l\'estat de las arreviradas t&agrave; aquera lenga',
