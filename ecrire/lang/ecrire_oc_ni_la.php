...
'avis_connexion_echec_3' => '<MODIF><b>N.B.</b> Sus tot plen de servidors, dev&egrave;tz <b>demandar</b> qu\'activen lo v&ograve;stre acc&egrave;s a la basa SQL avans de la poder utilizar. Se non vos pod&egrave;tz connectar, verificatz qu\'augatz ben realizat aqueu procediment.',
...
'avis_site_syndique_probleme' => '<MODIF>Atencion: la sindicacion d\'aqueu sit a rescontrat un probl&egrave;ma; lo sist&egrave;ma es doncas interromput tempor&agrave;riament. Verificatz l\'adrei&ccedil;a dau fichier de sindicacion d\'aqueu sit (<b>@url_syndic@</b>), e tornatz assaiar de recuperar li informacions.',
...
'ical_info2' => '<MODIF>Per tenir mai d\'informacions sobre aqueli tecnicas, non esitetz de consultar <a href="@spipnet@">la documentacion d\'SPIP</a>.',
...
'text_article_propose_publication' => '<MODIF>Article prepauat per la publicacion. Non esitetz de donar lo v&ograve;stre vejaire gaug au forum estacat a aquel article (en bas de p&agrave;gina).',
...
'texte_admin_tech_02' => '<MODIF>Atencion: aquela sauvagarda si porr&agrave; restaurar BASTA dins un sit installat emb la meteissa version d\'SPIP. Doncas sobretot non cau "vuar la basa" en esperant de re&iuml;nstallar la sauvagarda apr&egrave;s una actualizacion. Consultatz <a href="@spipnet@">la documentacion d\'SPIP</a>.',
...
'texte_connexion_mysql' => '<MODIF>Consultatz li informacions que lo v&ograve;stre aubergador fornisse: i dev&egrave;tz trobar, se lo v&ograve;stre aubergador sup&ograve;rta SQL, lu c&ograve;des de connexion au servidor SQL.',
...
'texte_en_cours_validation' => '<MODIF>Si prepaua de publicar lu articles e br&egrave;vas &ccedil;ai sota. Non esitetz de donar lo v&ograve;stre vejaire gaug ai forums que i son estacats.',
...
'texte_syndication' => '<MODIF>Si p&ograve;u recuperar automaticament, quora un sit web o permete, 
