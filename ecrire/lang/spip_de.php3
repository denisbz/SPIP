...
'ical_texte_rss' => '<MODIF> Sie k&ouml;nne die Neuheiten dieser Website mit einem beliebigen Programm anzeigen, dass das Format XML/RSS (Rich Site Summary) beherrscht. Dieses Protokoll erlaubt es SPIP, neue Eintr&auml;ge aus anderen Websites zu &uuml;bernehmen, die damit arbeiten.',
...
'texte_jeu_caractere' => 'Sie ben&ouml;tigen diese Option, wenn Ihre Website einen anderen Zeichensatz als den des r&ouml;mischen (bzw. „westlichen“) Alphabets und seiner Ableitungen anzeigen soll. In diesem Fall m&uuml;ssen Sie die Grundeinstellungen auf den passenden Zeichensatz &auml;ndern. Es ist empfehlenswert, dazu einige Tests durchzuf&uuml;hren. Bitte vergessen Sie nicht, den &ouml;ffentlichen Bereich entsprechend zu &auml;ndern (SPIP-Tag <tt>#CHARSET</tt>).',
...
'titre_cadre_afficher_traductions' => '<MODIF> Stand der &Uuml;bersetzungen f&uuml;r diese Sprache anzeigen',
