...
'ical_texte_rss' => '<MODIF> Po&egrave;tz sindicar las novetats d\'aqueu sit dins tot legior de fichiers en format XML/RSS (Rich Site Summary). Es pereu lo format que permet a SPIP de legir las novetats publicaas dins d\'autres sits en utilizant un format d\'eschambi compatible. ',
