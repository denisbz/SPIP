...
'barre_aide_rac' => '<NEW><pLUS_UTILISE>M&aacute;s informaci&oacute;n acerca de los atajos tipogr&aacute;ficos',
...
'icone_calendrier_messagerie' => '<NEW><pLUS_UTILISE>Agenda et mensager&iacute;a',
...
'icone_etat_traductions' => '<NEW><pLUS_UTILISE>Estado de las traducciones',
...
'icone_forum_interne' => '<NEW><pLUS_UTILISE>Foro interno',
'icone_forum_suivi' => 'Seguiment dels f&ograve;rums',
'icone_forums_petitions' => '<NEW><pLUS_UTILISE>Foros y peticiones',
...
'icone_modifier_informations_personnelles' => '<NEW><pLUS_UTILISE>Modificar tus informaciones personales',
...
'info_dans_espace_prive' => '<NEW><pLUS_UTILISE>[en el espacio privado]',
...
'info_en_test_1' => '<NEW><pLUS_UTILISE>&nbsp;(en prueba)',
'info_en_test_2' => '<NEW><pLUS_UTILISE>(en prueba)',
...
'info_langue_defaut' => '<NEW><pLUS_UTILISE>Idioma por omisi&oacute;n',
'info_langue_interface' => '<NEW><pLUS_UTILISE>Idioma de la interfaz',
'info_langue_principale' => 'Idioma principal del lloc',
'info_langues_proposees' => '<NEW><pLUS_UTILISE>Idiomas propuestos',
...
'info_lien' => '<NEW><pLUS_UTILISE>enlace :',
...
'info_nouveau' => '<NEW><pLUS_UTILISE>(Nuevo)',
...
'info_remplacer_vignette_defaut' => '<NEW><pLUS_UTILISE>Reemplazar el icono por defecto por una imagen de tu elecci&oacute;n...',
...
'info_sur_site_public' => '<NEW><pLUS_UTILISE>[en la parte p&uacute;blica]',
...
'info_tous_redacteur' => '<NEW><pLUS_UTILISE>Anuncios a todos',
'info_tous_resultats_enregistres' => '[tots els resultats s&oacute;n registrats]',
'info_tout_afficher' => 'Mostrar-ho tot',
'info_tout_site1' => '<NEW><pLUS_UTILISE>Idioma del art&iacute;culo.',
...
'item_administrateur' => '<NEW><pLUS_UTILISE>Administrador/a',
'item_breve_proposee' => 'Breu proposada',
'item_efface' => '<NEW><pLUS_UTILISE>Borrado',
...
'item_premier' => '<NEW><pLUS_UTILISE>1&deg;',
'item_redacteur' => '<NEW><pLUS_UTILISE>Redactor/a',
...
'lien_modifer_date' => '<NEW><pLUS_UTILISE>Modificar la fecha',
...
'lien_rendez_vous' => '<NEW><pLUS_UTILISE>Una cita',
'lien_rendez_vous_02' => '<NEW><pLUS_UTILISE>@total_messages@ citas',
'lien_repondre_message' => 'Respondre a aquest missatge',
'lien_supprimer' => 'suprimir',
'lien_test_format_image' => '<NEW><pLUS_UTILISE>Probar los formatos de imagen que este sitio puede utilizar para los iconos',
...
'lnfo_liens' => '<NEW><pLUS_UTILISE>enlaces:',
...
'login_identification' => '<NEW><pLUS_UTILISE>identificaci&oacute;n',
'login_login' => 'Login:',
...
'onglet_bilan_traductions' => '<NEW><pLUS_UTILISE>Balance de las traducciones',
'onglet_calendrier' => '<NEW><pLUS_UTILISE>Calendario',
'onglet_contenu_site' => 'Contingut del lloc',
'onglet_detail_traductions' => '<NEW><pLUS_UTILISE>Los art&iacute;culos por traducir',
...
'onglet_langues' => '<NEW><pLUS_UTILISE>Idiomas',
'onglet_messagerie' => 'Missatgeria',
'onglet_messagerie_personnelle' => '<NEW><pLUS_UTILISE>Mensager&iacute;a personal',
...
'texte_bilan_traductions' => '<NEW><pLUS_UTILISE>En este gr&aacute;fico, las barras verdes representan los art&iacute;culos traducidos y al d&iacute;a, las barras rojas las traducciones que deben ser actualizadas.',
'texte_choix_langue_defaut' => '<NEW><pLUS_UTILISE>Elige aqu&iacute; el idioma principal de tu sitio y los idiomas que ser&aacute;n propuestos a los redactores y redactoras.',
...
'texte_plan_trad' => '<NEW><pLUS_UTILISE>Esta p&aacute;gina le permite visualizar el estado de las traducciones por idioma escogido. 
...
'texte_plan_trad_en_cours' => '<NEW><pLUS_UTILISE>Ese s&iacute;mbolo indica que un art&iacute;culo est&aacute; en curso de traducci&oacute;n:q uiere decir que una traducci&oacute;n fue empezada pero a&uacute;n no ha  sido publicada. Pincha en el s&iacute;mbolo para acceder a la traducci&oacute;n.',
'texte_plan_trad_modif' => '<NEW><pLUS_UTILISE>Este s&iacute;mbolo indica que hubieron modificacciones en un art&iacute;culo ya traducido. En este caso se aconseja actualizar la traducci&oacute;n en funci&oacute;n de las modificaciones aportadas al art&iacute;culo original. ',
'texte_plan_trad_note' => '<NEW><pLUS_UTILISE>Nota: s&oacute;lo los art&iacute;culos publicados aparecen en esta p&aacute;gina.',
...
'titre_articles_populaires' => '<NEW><pLUS_UTILISE>Los art&iacute;culos m&aacute;s populares',
'titre_articles_visites' => '<NEW><pLUS_UTILISE>Los art&iacute;culos m&aacute;s visitados',
...
'titre_page_admin_vider' => '<NEW><pLUS_UTILISE>Mantenimiento t&eacute;cnico: gesti&oacute;n de la cach&eacute;',
'titre_page_etat_traductions' => '<NEW><pLUS_UTILISE>Estado de las traducciones',
