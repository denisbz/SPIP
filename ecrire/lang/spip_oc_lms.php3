...
'ical_texte_rss' => '<MODIF> Podetz sindicar las novetats de queu sit dins tot legidor de fichiers en format XML/RSS (Rich Site Summary). Es tanben lo format que permet a SPIP de legir las novetats publicadas dins d\'autres sits en utilizar un format d\'eschamge compatible. ',
...
'titre_cadre_afficher_traductions' => '<MODIF> Afichar l\'estat de las reviradas per quela lenga',
