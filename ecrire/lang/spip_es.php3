...
'info_erreur_squelette' => 'Error en el sitio',
...
'info_historique_lien' => 'Mostrar el hist&oacute;rico',
...
'barre_aide_rac' => '<PLUS_UTILISE>M&aacute;s informaci&oacute;n acerca de los atajos tipogr&aacute;ficos',
'icone_calendrier_messagerie' => '<PLUS_UTILISE>Agenda et mensager&iacute;a',
'icone_etat_traductions' => '<PLUS_UTILISE>Estado de las traducciones',
'icone_evolution_visites_2' => '<PLUS_UTILISE><NEW><PLUS_UTILISE><NEW><NEW><NEW><NEW>Evolution des visites',
'icone_forum_interne' => '<PLUS_UTILISE>Foro interno',
'icone_forums_petitions' => '<PLUS_UTILISE>Foros y peticiones',
'icone_modifier_informations_personnelles' => '<PLUS_UTILISE>Modificar tus informaciones personales',
'info_dans_espace_prive' => '<PLUS_UTILISE>[en el espacio privado]',
'info_en_test_1' => '<PLUS_UTILISE>&nbsp;(en prueba)',
'info_en_test_2' => '<PLUS_UTILISE>(en prueba)',
'info_langue_defaut' => '<PLUS_UTILISE>Idioma por defecto',
'info_langue_interface' => '<PLUS_UTILISE>Idioma de la interfaz',
'info_langues_proposees' => '<PLUS_UTILISE>Idiomas propuestos',
'info_lettre_heures' => '<PLUS_UTILISE>H',
'info_lien' => '<PLUS_UTILISE>enlace :',
'info_nouveau' => '<PLUS_UTILISE>(Nuevo)',
'info_question_referers' => '<PLUS_UTILISE><NEW><PLUS_UTILISE><NEW><NEW><NEW><NEW>Votre site doit-il conserver les <i>referers</i>
		(adresses des liens externes menant &agrave; votre site)&nbsp;?',
'info_remplacer_vignette_defaut' => '<PLUS_UTILISE>Reemplazar el icono por defecto por una imagen de tu elecci&oacute;n...',
'info_sur_site_public' => '<PLUS_UTILISE>[en la parte p&uacute;blica]',
'info_tous_redacteur' => '<PLUS_UTILISE>Anuncios a todos',
'info_tout_site1' => '<PLUS_UTILISE>Idioma del art&iacute;culo.',
'item_administrateur' => '<PLUS_UTILISE>Administrador/a',
'item_efface' => '<PLUS_UTILISE>Borrado',
'item_gerer_referers' => '<PLUS_UTILISE><NEW><PLUS_UTILISE><NEW><NEW><NEW><NEW>G&eacute;rer les referers',
'item_non_gerer_referers' => '<PLUS_UTILISE><NEW><PLUS_UTILISE><NEW><NEW><NEW><NEW>Ne pas g&eacute;rer les referers',
'item_non_utiliser_moteur_recherche_forum' => '<PLUS_UTILISE><NEW><PLUS_UTILISE><NEW><NEW><NEW><NEW>Ne pas indexer les forums',
'item_premier' => '<PLUS_UTILISE>1&deg;',
'item_redacteur' => '<PLUS_UTILISE>Redactor/a',
'item_utiliser_moteur_recherche_forum' => '<PLUS_UTILISE><NEW><PLUS_UTILISE><NEW><NEW><NEW><NEW>Indexer les forums',
'lien_modifer_date' => '<PLUS_UTILISE>Modificar la fecha',
'lien_rendez_vous' => '<PLUS_UTILISE>Una cita',
'lien_rendez_vous_02' => '<PLUS_UTILISE>@total_messages@ citas',
'lien_test_format_image' => '<PLUS_UTILISE>Probar los formatos de imagen que este sitio puede utilizar para los iconos',
'lnfo_liens' => '<PLUS_UTILISE>enlaces:',
'login_identification' => '<PLUS_UTILISE>identificaci&oacute;n',
'onglet_agenda' => '<PLUS_UTILISE>Agenda',
'onglet_bilan_traductions' => '<PLUS_UTILISE>Balance de las traducciones',
'onglet_calendrier' => '<PLUS_UTILISE>Calendario',
'onglet_detail_traductions' => '<PLUS_UTILISE>Los art&iacute;culos por traducir',
'onglet_langues' => '<PLUS_UTILISE>Idiomas',
'onglet_messagerie_personnelle' => '<PLUS_UTILISE>Mensager&iacute;a personal',
'texte_bilan_traductions' => '<PLUS_UTILISE>En este gr&aacute;fico, las barras verdes representan los art&iacute;culos traducidos y al d&iacute;a, las barras rojas las traducciones que deben ser actualizadas.',
'texte_choix_langue_defaut' => '<PLUS_UTILISE>Elige aqu&iacute; el idioma principal de tu sitio y los idiomas que ser&aacute;n propuestos a los redactores y redactoras.',
'texte_plan_trad' => '<PLUS_UTILISE>Esta p&aacute;gina le permite visualizar el estado de las traducciones por idioma escogido. 
...
'texte_plan_trad_en_cours' => '<PLUS_UTILISE>Ese s&iacute;mbolo indica que un art&iacute;culo est&aacute; en curso de traducci&oacute;n:q uiere decir que una traducci&oacute;n fue empezada pero a&uacute;n no ha  sido publicada. Pincha en el s&iacute;mbolo para acceder a la traducci&oacute;n.',
'texte_plan_trad_modif' => '<PLUS_UTILISE>Este s&iacute;mbolo indica que hubieron modificacciones en un art&iacute;culo ya traducido. En este caso se aconseja actualizar la traducci&oacute;n en funci&oacute;n de las modificaciones aportadas al art&iacute;culo original. ',
'texte_plan_trad_note' => '<PLUS_UTILISE>Nota: s&oacute;lo los art&iacute;culos publicados aparecen en esta p&aacute;gina.',
'titre_articles_populaires' => '<PLUS_UTILISE>Los art&iacute;culos m&aacute;s populares',
'titre_articles_visites' => '<PLUS_UTILISE>Los art&iacute;culos m&aacute;s visitados',
'titre_page_admin_vider' => '<PLUS_UTILISE>Mantenimiento t&eacute;cnico: gesti&oacute;n de la cach&eacute;',
'titre_page_etat_traductions' => '<PLUS_UTILISE>Estado de las traducciones'
