...
'barre_aide_rac' => 'M&aacute;s informaci&oacute;n acerca de los atajos tipogr&aacute;ficos',
...
'barre_guillemets' => '<MODIF> Poner entre &laquo; comillas francesas &raquo;',
'barre_guillemets_simples' => '<MODIF> Poner entre „comillas“',
...
// C
'calendrier_synchro' => '<MODIF> Si utilizas un software de agenda compatible <b>iCal</b> (Apple iCal, Mozilla Calendar, Ximian Evolution, KOrganizer...), puedes sincronizarlo con la actualidad de este sitio.',
'calendrier_synchro_lien' => '<MODIF> R&eacute;cuperar el archivo <i>iCal</i>',
...
'icone_agenda' => '<MODIF> Agenda et mensager&iacute;a',
...
'icone_calendrier_messagerie' => 'Agenda et mensager&iacute;a',
...
'icone_edition_site' => '<MODIF> Edici&oacute;n del sitio',
'icone_envoyer_message' => 'Enviar el mensaje',
'icone_etat_traductions' => 'Estado de las traducciones',
...
'icone_suivi_activite' => 'Seguir la actividad editorial',
...
'info_afficher_visites' => '<MODIF> Mostrar las visitas de:',
...
'info_config_suivi_explication' => 'Puedes recibir automaticamente, por correo electr&oacute;nico, los anuncios acerca de la actividad editorial del sitio. Para esto, te puedes suscribir a la lista de correo siguiente:',
...
'info_forum_ouvert' => 'En el espacio privado del sitio hay un foro abierto a todos los redactores/as inscritos. A continuaci&oacute;n, puedes activar un foro suplementario reservado  a los administradores/as.',
...
'info_langue_interface' => 'Idioma de la interfaz',
...
'info_urlref' => '<MODIF> Direcci&oacute;n (URL) de referencia:',
...
'onglet_bilan_traductions' => 'Balance de las traducciones',
'onglet_calendrier' => 'Calendario',
'onglet_contenu_site' => 'Contenido del sitio',
'onglet_detail_traductions' => 'Los art&iacute;culos por traducir',
...
'onglet_langues' => 'Idiomas',
'onglet_messagerie' => 'Mensajer&iacute;a',
'onglet_messagerie_personnelle' => 'Mensager&iacute;a personal',
...
'pass_espace_prive_bla' => 'El espacio privado de este sitio est&aacute; abierto a los visitantes, despu&eacute;s de haberse inscrito. Una vez registrado, puedes consultar los art&iacute;culos en curso de redacci&oacute;n, proponer art&iacute;culos y participar en todos los foros.',
...
'texte_auteur_messagerie' => '<MODIF> En este sitio, SPIP puede indicarte permanentemente una lista de los redactores que se conectan y permite intercambiar mensajes con ellos. Si se desactiva la mensajer&iacute;a, se desactiva l&oacute;gicamente, la lista. A&uacute;n cuando la mensajer&iacute;a est&aacute; activada, puedes ser "invisible" y no aparecer en la lista.',
...
'texte_bilan_traductions' => 'En este gr&aacute;fico, las barras verdes representan los art&iacute;culos traducidos y al d&iacute;a, las barras rojas las traducciones que deben ser actualizadas.',
...
'texte_documents_joints' => 'Puedes autorizar el a&ntilde;adir documentos (archivos de ofim&aacute;tica, im&aacute;genes,
  ...
  pueden ser referenciados en el art&iacute;culo, o mostrados separadamente.<p>',
...
'texte_plan_trad' => 'Esta p&aacute;gina le permite visualizar el estado de las traducciones por idioma escogido. 
...
'texte_plan_trad_en_cours' => 'Ese s&iacute;mbolo indica que un art&iacute;culo est&aacute; en curso de traducci&oacute;n:q uiere decir que una traducci&oacute;n fue empezada pero a&uacute;n no ha  sido publicada. Pincha en el s&iacute;mbolo para acceder a la traducci&oacute;n.',
'texte_plan_trad_modif' => 'Este s&iacute;mbolo indica que hubieron modificacciones en un art&iacute;culo ya traducido. En este caso se aconseja actualizar la traducci&oacute;n en funci&oacute;n de las modificaciones aportadas al art&iacute;culo original. ',
'texte_plan_trad_note' => 'Nota: s&oacute;lo los art&iacute;culos publicados aparecen en esta p&aacute;gina.',
...
'titre_articles_populaires' => 'Los art&iacute;culos m&aacute;s populares',
'titre_articles_syndiques' => 'Art&iacute;culos sindicados de este sitio',
'titre_articles_visites' => 'Los art&iacute;culos m&aacute;s visitados',
...
'titre_cadre_afficher_traductions' => 'Mostrar el estado de las traducciones para este idioma',
...
'titre_page_etat_traductions' => 'Estado de las traducciones',
