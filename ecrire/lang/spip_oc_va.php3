...
'barre_guillemets' => '<MODIF> Enroar amb de &laquo; vergetas francesas &raquo;',
'barre_guillemets_simples' => '<MODIF> Enroar amb de &#8222;vergetas&#8220;',
...
'ical_texte_rss' => 'Po&egrave;tz sindicar las novetats d\'aqueu sit dins tot legior de fichiers en format XML/RSS (Rich Site Summary). Es pereu lo format que permet a SPIP de legir las novetats publicaas dins d\'autres sits en utilizant un format d\'eschambi compatible. ',
...
'info_gauche_messagerie' => 'La messatjari&aacute; vos permet d\'eschambiar de messatges entre redactors, de servar de n&ograve;tas per se remembrar (per v&ograve;stre usatge personau) o d\'afichar d\'anoncis sus la pagina d\'acuelh de l\'espaci privat (se siatz administrator/tritz).',
