...
'avis_site_syndique_probleme' => 'Paznja : Problem prilikom sindikacije ove stranice; Doslo je do privremenog prekida sistema. Provjerite adresu dokumenta sindikacije ove stranice \f1 (<b>@url_syndic@</b>)\f0  i pokusajte povratiti informacije.',
...
'bouton_forum_petition' => 'PETICIJA & FORUM',
...
'bouton_radio_sauvegarde_compressee' => 'Snimiti sa kompresijom pod <b>ecrire/data/dump.xml.gz</b>',
'bouton_radio_sauvegarde_non_compressee' => 'Snimiti bez  kompresije pod <b>ecrire/data/dump.xml</b>',
...
'entree_titre_obligatoire' => '<B>Naslov</B> [Obavezno]<BR>',
...
'icone_evolution_visites' => 'Nivo posjeta <br>@visites@ posjete',
...
'info_activer_forum_public' => '<I>Da bi ste aktivirali javne forume, izaberite njihov standardni nacin moderacije</I>',
...
'info_creation_rubrique' => 'Prije nego mozete pisati clanke,<BR> morate kreirati najmanje jednu rubriku.<BR>',
'info_creation_tables' => 'Cetvrta etapa: <B>Kreiranje tabela baze</B>',
'info_creer_base' => '<B>Kreirati</B> novu bazu podataka:',
...
'info_derniere_etape' => 'Posljednja etapa: <B>Zavrseno je!',
...
'info_informations_personnelles' => 'Peta etapa: <B>Licne informacije</B>',
...
'info_option_email' => 'Kada posjetioc sranice postavi novu poruku u forum vezan za neki clanak, autori clanka mogu biti o tome upozoreni putem e-maila. Zelite li koristiti ovu opciju?',
...
'info_restauration_sauvegarde' => 'obnavljanje backup arhiva @archive@', 'info_restreindre_rubrique' => 'Ograniciti uredjivanje rubrike:',
...
'info_sauvegarde_reussi_02' => 'Baza je pohranjena u <b>ecrire/data/@archive@</b>. Mozete se',
...
'info_statut_auteur' => 'Status ovog autora:',
...
'item_non_activer_messages_avertissement' => 'Bez poruka upozorenja', 'item_non_afficher_calendrier' => 'Ne prikazuj u kalendaru',
...
'text_article_propose_publication' => 'Clanak predlozen za objavljivanje. Ne oklijevajte da date vase misljenje u forumu dodanom ovom clanku (na dnu ove strane).',
...
'texte_admin_tech_01' => 'Ova opcija vam omogucuje pohranjivanja sadrzaja baze u dokument koji ce biti pohranjen u  direktoriju <i>ecrire/data/</i>. Ne zaboravite sacuvati sve sto  obuhvata IMG repertoar, sto ukljucuje slike i dokumente koristene u clancima i rubrikama.',
'texte_admin_tech_02' => 'Paznja: Ovo pohranjivanje ne moze biti obnovljeno, OSIM na stranici koja je instalirana sa istom verzijom SPIP-a. Nije preporuceno praznjenje baze, ako namjerevate reinstalaciju backup-a nakon update-a  ... Konsultujte <a  href="http://www.spip.net/fr_article1489.html">SPIP  dokumentaciju</a>.',
...
'texte_creer_rubrique' => 'Prije pisanja clanaka,<BR> trebate kreirati rubriku.',
...
'texte_en_cours_validation' => 'Dole navedeni clanci i kratke poruke su predlozene za publikaciju. Vase misljenje mozete iznijeti u njima prikljucenim forumima.',
...
'texte_restaurer_sauvegarde' => 'Ova opcija vam omogucava obnavljanje ranije izvedenog pohranjivanja baze. U tom slucaju, dokument koji, sadrzi pohranjeni materijal, se treba nalaziti u repertoaru <i>ecrire/data/</i>. Budite oprezni sa ovom funkcijom: <b>moguce izmjene i gubitci su nepovratni.</b>',
'texte_sauvegarde' => 'Snimiti sadrzj baze',
'texte_sauvegarde_base' => 'Snimiti bazu',
'texte_sauvegarde_compressee' => 'Pohranjivanje ce se izvrsiti u nekompresovanom dokumentu <b>ecrire/data/dump.xml</b>.',
...
'texte_syndication' => 'Moguce je automatsko otkrivanje spiska novosti, ako web stranica to dozvoljava. Zato trebate aktivirati sindikaciju\tab <blockquote><i>Odredjeni hosting servisi dezaktiviraju tu funkciju; u tom slucaju ne mozete koristiti sindikaciju sadrzaja na vasoj stranici.</i></blockquote>',
...
'texte_titre_obligatoire' => '<B>Naslov</B> [Obavezan]',
...
'titre_cadre_signature_obligatoire' => '<B>Potpis</B>  [Obavezno]<BR>',
...
'trad_deja_traduit' => 'Ovaj clanak je vec prevod prethodnog clanka.',
