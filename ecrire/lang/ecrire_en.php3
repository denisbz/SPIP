...
'texte_nouvelle_version_spip_2' => 'This new version requires an update more thorough than usual. If you are the webmaster of this site, please delete the file @connect@ and restart installation in order to update your database connection parameters. <p />(NB.: if you forgot your connection parameters, have a look at the file @connect@ before deleting it...)',
